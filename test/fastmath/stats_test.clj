...
(def ^:private normal-kurt-data (r/->seq (r/distribution :normal {:rng kurt-rng}) kurt-n))
(def ^:private uniform-kurt-data (r/->seq (r/distribution :uniform-real {:lower -1 :upper 1 :rng kurt-rng}) kurt-n)) ; Platykurtic
(def ^:private laplace-kurt-data (r/->seq (r/distribution :laplace {:rng kurt-rng}) kurt-n))     ; Leptokurtic
...
#_(t/deftest kurtosis-tests
    (let [tol 1e-2] ; Tolerance might need adjustment based on N and method stability
      ...
      (t/testing "Uniform Data (Platykurtic, Excess Kurtosis = -1.2)"
      ...
      (t/testing "Laplace Data (Leptokurtic, Excess Kurtosis = 3)"
      ...
      (t/testing "Parameterized Robust Kurtosis"
      ...
      (t/testing "L-Kurtosis (using specific data)"
