...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x5e093fdc "org.apache.commons.math3.random.JDKRandomGenerator@5e093fdc"]
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x61ad2786 "org.apache.commons.math3.random.ISAACRandom@61ad2786"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x2544766d "org.apache.commons.math3.random.ISAACRandom@2544766d"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x4d11030b "org.apache.commons.math3.random.SynchronizedRandomGenerator@4d11030b"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 138981996
(r/irandom my-prng 5) ;; => 0
(r/irandom my-prng 10 20) ;; => 13
(r/lrandom my-prng) ;; => 7441130657643806870
(r/lrandom my-prng 5) ;; => 3
(r/lrandom my-prng 10 20) ;; => 14
(r/frandom my-prng) ;; => 0.068743944
(r/frandom my-prng 2.5) ;; => 1.9600608
(r/frandom my-prng 10.1 10.11) ;; => 10.102063
(r/drandom my-prng) ;; => 0.595538223788624
(r/drandom my-prng 2.5) ;; => 0.6810187012073393
(r/drandom my-prng 10.1 10.11) ;; => 10.106808450597443
(r/grandom my-prng) ;; => 1.5290666859600923
(r/grandom my-prng 20.0) ;; => -2.236942274549658
(r/grandom my-prng 10.0 20.0) ;; => -18.635356610843825
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.5051871132799919 0.1383697607989336)
(r/->seq my-prng 2) ;; => (0.7275812080620592 0.7381431521463031)
(r/->seq my-prng 5 :antithetic) ;; => (0.0884915685085883 0.9115084314914117 0.3820817385018098 0.6179182614981902 0.44129401074200647)
(r/->seq my-prng 5 :uniform) ;; => (0.12925180092554334 0.31142501105269865 0.3765566359333551 0.46532237930340403 0.5192060344821042)
(r/->seq my-prng 5 :systematic) ;; => (0.09116945087123143 0.2911694508712314 0.49116945087123143 0.6911694508712314 0.8911694508712314)
(r/->seq my-prng 5 :stratified) ;; => (0.15195882238239183 0.23273032176652506 0.5902424141399933 0.718062602668155 0.8425850700623233)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x66c39cb9 "org.apache.commons.math3.random.ISAACRandom@66c39cb9"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x4958f442 "org.apache.commons.math3.random.ISAACRandom@4958f442"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5e093fdc "org.apache.commons.math3.random.JDKRandomGenerator@5e093fdc"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x44959c6d "org.apache.commons.math3.random.JDKRandomGenerator@44959c6d"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x60a8ff4f "org.apache.commons.math3.random.JDKRandomGenerator@60a8ff4f"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5e093fdc "org.apache.commons.math3.random.JDKRandomGenerator@5e093fdc"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5e093fdc "org.apache.commons.math3.random.JDKRandomGenerator@5e093fdc"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x29263c45 "org.apache.commons.math3.distribution.CauchyDistribution@29263c45"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x159859f9 "org.apache.commons.math3.distribution.CauchyDistribution@159859f9"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 2.331604372944444
(r/frandom log-logistic) ;; => 4.9036064
(r/lrandom log-logistic) ;; => 6
(r/irandom log-logistic) ;; => 8
(r/sample log-logistic) ;; => 14.68041642505487
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.15646783816284204 0.15438581300157747 0.6891463488355806]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 12.27978613033839
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 12.492053224898573
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 147443.39515437186
...
::: {.sourceClojure}
```clojure
(r/drandom poisson) ;; => 14.0
(r/frandom poisson) ;; => 14.0
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.5338715330299423
(r/->seq weibull 3) ;; => (0.6619927222322887 1.2558286939467602 1.2007256753763584)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x681ab75 "org.apache.commons.math3.distribution.CauchyDistribution@681ab75"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (-1.2792385602765333 0.22054964234941557 -0.19600495239185897)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.3216540187573013 0.053535433281901815 0.6248105479607968]
(r/sample dirichlet3) ;; => [0.628894435380903 0.014270376010724282 0.35683518860837266]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [13 25 27 33 52]
(r/sample multinomial) ;; => [11 17 30 50 42]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => -2.7910519480927025
(r/sample mixture-of-three) ;; => 6.336467923614919
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.7200887615311456
(r/sample truncated-normal) ;; => -1.2198160555866309
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.06737675113604297
(r/sample kde-distr) ;; => 1.8464484918475896
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 1.3111892978514645
(r/sample empirical-distr) ;; => 1.8260314750487767
...
(r/pdf cat-distr nil) ;; => 0.25000000000000006
(r/pdf cat-distr "ss") ;; => 0.0
(r/cdf cat-distr :b) ;; => 0.7300000000000002
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => ("s" nil :a)
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [0.8918917984933326, -0.36359934573374136, -0.17604207810688333, 0.20330696569014536]
...
([0.4536544900345152
  ...
  -0.2015977104922559
  -0.02709603637201534
  -0.028976117103412437
  0.019867608616011338
  -0.20673180782501774
  0.04838159159654582
  0.0027248911576392763]
 [-0.048452198096207176
  0.25918364732373506
  0.20856820948090948
  0.3123734316109974
  -0.18599418061770037
  ...
  0.24161842145916296
  -0.6172019802858504
  0.018271938582738786
  0.24374606216435465
  -0.026045992761707406])
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.6498912500789067
(r/vnoise 0.2 0.3) ;; => 0.4083070992879408
(r/vnoise 0.2 0.3 0.4) ;; => 0.3342123320857708
(r/noise 0.2) ;; => 0.7372368253968253
(r/noise 0.2 0.3) ;; => 0.4599388379428571
(r/noise 0.2 0.3 0.4) ;; => 0.46540649068599915
(r/simplex 0.2) ;; => 0.6685678778514286
(r/simplex 0.2 0.3) ;; => 0.5749963824513242
(r/simplex 0.2 0.3 0.4) ;; => 0.2126560807619048
```
:::
