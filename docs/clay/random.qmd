...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x5842ba77 "org.apache.commons.math3.random.JDKRandomGenerator@5842ba77"]
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x42936a "org.apache.commons.math3.random.ISAACRandom@42936a"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x363f8c23 "org.apache.commons.math3.random.ISAACRandom@363f8c23"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x3ef06630 "org.apache.commons.math3.random.SynchronizedRandomGenerator@3ef06630"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => -1354337954
(r/irandom my-prng 5) ;; => 1
(r/irandom my-prng 10 20) ;; => 10
(r/lrandom my-prng) ;; => -6826209870515164246
(r/lrandom my-prng 5) ;; => 0
(r/lrandom my-prng 10 20) ;; => 11
(r/frandom my-prng) ;; => 0.22700429
(r/frandom my-prng 2.5) ;; => 0.5085671
(r/frandom my-prng 10.1 10.11) ;; => 10.107816
(r/drandom my-prng) ;; => 0.5838410879168794
(r/drandom my-prng 2.5) ;; => 2.266047610962426
(r/drandom my-prng 10.1 10.11) ;; => 10.102809789943594
(r/grandom my-prng) ;; => -0.8676011682916708
(r/grandom my-prng 20.0) ;; => 20.436523904893104
(r/grandom my-prng 10.0 20.0) ;; => 18.908400738726186
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.20471548615673196 0.07265769104777675)
(r/->seq my-prng 2) ;; => (0.5537019215144592 0.6601474133625342)
(r/->seq my-prng 5 :antithetic) ;; => (0.7132102152456159 0.2867897847543841 0.7102728913316101 0.2897271086683899 0.7335086466893015)
(r/->seq my-prng 5 :uniform) ;; => (0.19182768144175794 0.23612510132030312 0.36040701751432647 0.6830349939866879 0.7381106444747937)
(r/->seq my-prng 5 :systematic) ;; => (0.019861626406011013 0.21986162640601103 0.41986162640601105 0.6198616264060111 0.819861626406011)
(r/->seq my-prng 5 :stratified) ;; => (0.17263740705339098 0.34403837172737317 0.45846483919989534 0.7481743319667766 0.8258130646343205)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x8708a94 "org.apache.commons.math3.random.ISAACRandom@8708a94"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x5fb3d9c "org.apache.commons.math3.random.ISAACRandom@5fb3d9c"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5842ba77 "org.apache.commons.math3.random.JDKRandomGenerator@5842ba77"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5ea84f96 "org.apache.commons.math3.random.JDKRandomGenerator@5ea84f96"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x1b9ea614 "org.apache.commons.math3.random.JDKRandomGenerator@1b9ea614"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5842ba77 "org.apache.commons.math3.random.JDKRandomGenerator@5842ba77"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x5842ba77 "org.apache.commons.math3.random.JDKRandomGenerator@5842ba77"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x4e42414e "org.apache.commons.math3.distribution.CauchyDistribution@4e42414e"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x5da5914d "org.apache.commons.math3.distribution.CauchyDistribution@5da5914d"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 6.616397852954787
(r/frandom log-logistic) ;; => 7.9315395
(r/lrandom log-logistic) ;; => 8
(r/irandom log-logistic) ;; => 50
(r/sample log-logistic) ;; => 3.1206167644126617
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.10537555328834669 0.7008146642096991 0.1938097825019542]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 10.775035439013214
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 14.610887953013592
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 602168.5427976636
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.8449832135045761
(r/->seq weibull 3) ;; => (0.7117632671908962 0.43994406933894725 1.1874723577749169)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x6c70630f "org.apache.commons.math3.distribution.CauchyDistribution@6c70630f"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (0.5258212584916888 -2.0909451247029494 0.8526921194911457)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.22822273951197491 0.3894737594278092 0.382303501060216]
(r/sample dirichlet3) ;; => [0.6647713711945974 0.032125842815908856 0.3031027859894936]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [14 16 34 41 45]
(r/sample multinomial) ;; => [12 21 33 36 48]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 1.0967092226645234
(r/sample mixture-of-three) ;; => 7.670668503252401
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => 0.8217116810972349
(r/sample truncated-normal) ;; => -1.2942635080567746
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.783240684900346
(r/sample kde-distr) ;; => -2.08374270801779
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => -1.2900707675082674
(r/sample empirical-distr) ;; => -0.779477694069603
...
(r/pdf cat-distr nil) ;; => 0.23000000000000007
(r/pdf cat-distr "ss") ;; => 0.0
(r/cdf cat-distr :b) ;; => 0.47000000000000014
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => ("s" :a nil)
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [0.3946595643664854, 0.21881572330769603, 0.509787731518307, 0.7324479341774432]
...
([-0.16757263864885807
  ...
  -0.19227447390188163
  -0.19618802791038567
  0.018331569049061327
  0.2883187250387957
  0.004328883227155752
  -0.15671090277865096
  -0.14394460744530807
  0.4559516006174552]
 [-0.32904577289832737
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.2943793397127722
(r/vnoise 0.2 0.3) ;; => 0.6136439007826043
(r/vnoise 0.2 0.3 0.4) ;; => 0.553219891651725
(r/noise 0.2) ;; => 0.7868114285714286
(r/noise 0.2 0.3) ;; => 0.5070915068749207
(r/noise 0.2 0.3 0.4) ;; => 0.4995349509822821
(r/simplex 0.2) ;; => 0.36129925278476194
(r/simplex 0.2 0.3) ;; => 0.44756949327303275
(r/simplex 0.2 0.3 0.4) ;; => 0.6925443924656084
```
:::
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.6872848415307672
(some-random-noise 0.2 0.3) ;; => 0.4627147909729545
(some-random-noise 0.2 0.3 0.4) ;; => 0.5339381071252284
```
:::
...
+ `(billow-noise)`
+ `(billow-noise cfg__15508__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__15508__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__15508__auto__)`
