...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x42829589 "org.apache.commons.math3.random.JDKRandomGenerator@42829589"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => -1146724192
(r/drandom (r/rng :mersenne) 0 10) ;; => 5.943322986966799
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.3551546602335809 0.3948028643233106 0.7136301469297295)
(r/->seq (r/rng :mersenne) 3) ;; => (0.9176338605307985 0.6592070787796933 0.6146108581031222)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x68a5fd24 "org.apache.commons.math3.random.ISAACRandom@68a5fd24"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x4b912ee5 "org.apache.commons.math3.random.ISAACRandom@4b912ee5"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x24e76ada "org.apache.commons.math3.random.SynchronizedRandomGenerator@24e76ada"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => -1149408973
(r/irandom my-prng 5) ;; => 2
(r/irandom my-prng 10 20) ;; => 17
(r/lrandom my-prng) ;; => -7169833792163071950
(r/lrandom my-prng 5) ;; => 2
(r/lrandom my-prng 10 20) ;; => 10
(r/frandom my-prng) ;; => 0.8339381
(r/frandom my-prng 2.5) ;; => 1.8994548
(r/frandom my-prng 10.1 10.11) ;; => 10.10187
(r/drandom my-prng) ;; => 0.6479867697601784
(r/drandom my-prng 2.5) ;; => 1.17059252993241
(r/drandom my-prng 10.1 10.11) ;; => 10.103574774848347
(r/grandom my-prng) ;; => -0.34796832903900227
(r/grandom my-prng 20.0) ;; => 2.4490677205801137
(r/grandom my-prng 10.0 20.0) ;; => -4.123397504356873
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.3532951592633955 0.6867957617622553)
(r/->seq my-prng 2) ;; => (0.8544388012917576 0.2818945363350558)
(r/->seq my-prng 5 :antithetic) ;; => (0.9362530971727379 0.06374690282726214 0.760603301900848 0.23939669809915198 0.42234426737256414)
(r/->seq my-prng 5 :uniform) ;; => (0.32471284236761205 0.35864501351260974 0.5789657983988176 0.7387255507485982 0.7996704974324974)
(r/->seq my-prng 5 :systematic) ;; => (0.13924336660432624 0.33924336660432625 0.5392433666043263 0.7392433666043262 0.9392433666043263)
(r/->seq my-prng 5 :stratified) ;; => (0.13181685800656906 0.26046938071441555 0.517908916802637 0.6199606053841813 0.9624568926860753)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x7ff6fcf6 "org.apache.commons.math3.random.ISAACRandom@7ff6fcf6"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x74ad651b "org.apache.commons.math3.random.ISAACRandom@74ad651b"]
...
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x34c75e1f "org.apache.commons.math3.random.JDKRandomGenerator@34c75e1f"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x72e756d4 "org.apache.commons.math3.random.JDKRandomGenerator@72e756d4"]
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x755f5c85 "org.apache.commons.math3.distribution.CauchyDistribution@755f5c85"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x3da8f45 "org.apache.commons.math3.distribution.CauchyDistribution@3da8f45"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 6.357200049808843
(r/frandom log-logistic) ;; => 6.988495
(r/lrandom log-logistic) ;; => 8
(r/irandom log-logistic) ;; => 6
(r/sample log-logistic) ;; => 10.637438293467811
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.08957812034688721 0.253725398839854 0.6566964808132588]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 14.051682605380732
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 14.180473013241443
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 35001.00680287232
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.9172571325041096
(r/->seq weibull 3) ;; => (1.450902980074256 0.27855955399109167 0.8559764191103654)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x5447c969 "org.apache.commons.math3.distribution.CauchyDistribution@5447c969"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (-0.6226357003737026 1.0416111307076834 -0.34053222363203567)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.30681015785749005 0.09084515126160149 0.6023446908809084]
(r/sample dirichlet3) ;; => [0.484465252438827 0.09474887563377443 0.4207858719273985]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [8 20 31 37 54]
(r/sample multinomial) ;; => [8 21 32 40 49]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => -1.180632675769903
(r/sample mixture-of-three) ;; => 1.1116455072032205
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.7608846964309064
(r/sample truncated-normal) ;; => -0.3597725451239277
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => -0.36618345931601204
(r/sample kde-distr) ;; => 0.6443182112299872
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 0.2609719263542673
(r/sample empirical-distr) ;; => 1.6570826514037473
...
(r/pdf cat-distr nil) ;; => 0.4200000000000002
(r/pdf cat-distr "ss") ;; => 0.0
(r/cdf cat-distr :b) ;; => 1.0000000000000002
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => (:a nil :b)
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [0.6179442939503781, 0.36035937304438964, -0.6971742112779911, -0.04726617143512258]
...
::: {.printedClojure}
```clojure
([-0.23712375328284147 0.3274534658700195 -0.19547744114101653 -0.06267674490221677 0.059089867206506226 0.09267557661409445 0.10694668699563963 0.17433751991413765 -0.18592319420261924 -0.26152577266236215 -0.11514361545057633 0.21871797334281826 -0.015251159377149551 -0.26204032417906903 0.13861545431035074 0.46753025823073824 -0.40692072642584 0.26485574445283544 0.18344502882174074 -0.018836240262760574] [-0.4634388872746937 0.15826199773058522 -0.007697902193940947 0.056781348316257044 0.2804543153003995 -0.07466029339473529 -0.024416164667996454 -0.3147663373976982 0.13326336724326276 -0.5729034531616125 -0.12603819009886155 0.10333756001141424 -0.09275561525002568 -0.0010342318660305847 0.11959424160886101 0.07859783400568233 0.19241580551448756 0.18056241546479787 -0.31605371254135217 0.04298788649196716])
...
::: {.printedClojure}
```clojure
{:interpolation :none, :warp-scale 0.0, :seed 665844940, :normalize? true, :noise-type :simplex, :lacunarity 1.90872786462909, :gain 0.24908653479282347, :generator :single, :warp-depth 1, :octaves 6}
...
::: {.printedClojure}
```clojure
{:interpolation :quintic, :warp-scale 4.0, :seed 1, :normalize? true, :noise-type :value, :lacunarity 1.8874943472437105, :gain 0.508204375355278, :generator :single, :warp-depth 1, :octaves 3}
