...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x2944f943 "org.apache.commons.math3.random.JDKRandomGenerator@2944f943"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => -1599750676
(r/drandom (r/rng :mersenne) 0 10) ;; => 3.7898333066003276
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.6846618383004432 0.9443362711343888 0.04267136290474571)
(r/->seq (r/rng :mersenne) 3) ;; => (0.1313810470721679 0.804195357083388 0.6438523438651598)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x179269f3 "org.apache.commons.math3.random.ISAACRandom@179269f3"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x53b8cafe "org.apache.commons.math3.random.ISAACRandom@53b8cafe"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x7eb45471 "org.apache.commons.math3.random.SynchronizedRandomGenerator@7eb45471"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => -805344990
(r/irandom my-prng 5) ;; => 4
(r/irandom my-prng 10 20) ;; => 10
(r/lrandom my-prng) ;; => 8706777012276931230
(r/lrandom my-prng 5) ;; => 4
(r/lrandom my-prng 10 20) ;; => 17
(r/frandom my-prng) ;; => 0.64877427
(r/frandom my-prng 2.5) ;; => 1.0085607
(r/frandom my-prng 10.1 10.11) ;; => 10.102393
(r/drandom my-prng) ;; => 0.785222108641831
(r/drandom my-prng 2.5) ;; => 0.23978613769660262
(r/drandom my-prng 10.1 10.11) ;; => 10.104972941020852
(r/grandom my-prng) ;; => -1.0107751628421058
(r/grandom my-prng 20.0) ;; => -22.846217081702626
(r/grandom my-prng 10.0 20.0) ;; => 9.952151139079303
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.0594184592399567 0.016644407887917323)
(r/->seq my-prng 2) ;; => (0.02552625075252979 0.4565410915178292)
(r/->seq my-prng 5 :antithetic) ;; => (0.42833390950930506 0.571666090490695 0.24066284888417622 0.7593371511158238 0.773454342166775)
(r/->seq my-prng 5 :uniform) ;; => (0.13076468576093495 0.17001639358562165 0.6939135616449035 0.7602656273884664 0.9182726954531343)
(r/->seq my-prng 5 :systematic) ;; => (0.0945292156864117 0.2945292156864117 0.49452921568641167 0.6945292156864117 0.8945292156864117)
(r/->seq my-prng 5 :stratified) ;; => (0.01015466111286818 0.37482520537662234 0.5266427390543577 0.7407733357919126 0.9030062159347253)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x75f5a63 "org.apache.commons.math3.random.ISAACRandom@75f5a63"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x2b020ce4 "org.apache.commons.math3.random.ISAACRandom@2b020ce4"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x2944f943 "org.apache.commons.math3.random.JDKRandomGenerator@2944f943"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x3b180e88 "org.apache.commons.math3.random.JDKRandomGenerator@3b180e88"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x6641a94b "org.apache.commons.math3.random.JDKRandomGenerator@6641a94b"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x2944f943 "org.apache.commons.math3.random.JDKRandomGenerator@2944f943"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x2944f943 "org.apache.commons.math3.random.JDKRandomGenerator@2944f943"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x3773f4d0 "org.apache.commons.math3.distribution.CauchyDistribution@3773f4d0"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x71f6aa2b "org.apache.commons.math3.distribution.CauchyDistribution@71f6aa2b"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 11.431815609315612
(r/frandom log-logistic) ;; => 7.5218616
(r/lrandom log-logistic) ;; => 8
(r/irandom log-logistic) ;; => 12
(r/sample log-logistic) ;; => 2.636980424369596
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.04389872710936939 0.5844880119208049 0.3716132609698256]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 11.094003911168315
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 13.880969952314722
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 326.5783438698332
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.5077680576999867
(r/->seq weibull 3) ;; => (2.0052809612516667 1.0927043858729482 1.483500158665878)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x5d910189 "org.apache.commons.math3.distribution.CauchyDistribution@5d910189"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (1.4601277271172284 0.8822701448177698 -0.07914103493108661)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.4972510271508121 0.03515081094494738 0.4675981619042406]
(r/sample dirichlet3) ;; => [0.35448411924542594 0.04661021973694216 0.598905661017632]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [8 10 43 36 53]
(r/sample multinomial) ;; => [14 15 35 35 51]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 0.9911146486842943
(r/sample mixture-of-three) ;; => 1.254974823526793
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.23761884299872663
(r/sample truncated-normal) ;; => 0.3654047624703455
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 1.7388351625534866
(r/sample kde-distr) ;; => 1.5515224660127775
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 2.9419026455905897
(r/sample empirical-distr) ;; => -0.16090902359721646
...
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => ("s" nil :b)
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [0.796177441268566, -0.3553522215209053, 0.0017180101469834196, -0.4897176013952649]
...
```clojure
([0.11452357042830145
  -0.046473952044592544
  0.4888756842183236
  -0.006549942201593232
  0.5436769962845127
  0.17569072896357574
  0.1365361038536479
  -0.026990750057942554
  0.0721345003541701
  0.2988588169677922
  0.1762222646466133
  0.22104311701543508
  0.030184410407996923
  -0.36633386083950603
  0.14034753838108033
  0.01885931612081579
  -0.11244022461354328
  -0.049240726205659925
  -0.193149425724151
  -0.13374038376939815]
 [-0.3572348490949666
  -0.0988413663137358
  -0.010090373517464151
  -0.09108407200553627
  0.0035272505492798326
  0.27901256494098137
  -0.02085133145979094
  -0.10265688937766242
  0.160720767612712
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.16466355496822438
(r/vnoise 0.2 0.3) ;; => 0.6932090362425753
(r/vnoise 0.2 0.3 0.4) ;; => 0.6094559446141358
(r/noise 0.2) ;; => 0.32464203174603173
(r/noise 0.2 0.3) ;; => 0.7279393982171428
(r/noise 0.2 0.3 0.4) ;; => 0.5578739200553415
(r/simplex 0.2) ;; => 0.5458422608457143
(r/simplex 0.2 0.3) ;; => 0.6802875760264118
(r/simplex 0.2 0.3 0.4) ;; => 0.7201667470899471
```
:::
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.17999999999999994
(some-random-noise 0.2 0.3) ;; => 0.5
(some-random-noise 0.2 0.3 0.4) ;; => 0.648
```
:::
...
+ `(billow-noise)`
+ `(billow-noise cfg__61406__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__61406__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__61406__auto__)`
