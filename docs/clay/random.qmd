...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x4c4b08ed "org.apache.commons.math3.random.JDKRandomGenerator@4c4b08ed"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => 1793874574
(r/drandom (r/rng :mersenne) 0 10) ;; => 6.115755627988473
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.021773268886278174 0.949164712937401 0.17787137851431623)
(r/->seq (r/rng :mersenne) 3) ;; => (0.6775705303634361 0.38441074666143704 0.650938759523312)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x1397e4c "org.apache.commons.math3.random.ISAACRandom@1397e4c"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x328e0d1a "org.apache.commons.math3.random.ISAACRandom@328e0d1a"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x4e78fc90 "org.apache.commons.math3.random.SynchronizedRandomGenerator@4e78fc90"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 1781486767
(r/irandom my-prng 5) ;; => 4
(r/irandom my-prng 10 20) ;; => 12
(r/lrandom my-prng) ;; => 3188190251830872680
(r/lrandom my-prng 5) ;; => 1
(r/lrandom my-prng 10 20) ;; => 16
(r/frandom my-prng) ;; => 0.9662312
(r/frandom my-prng 2.5) ;; => 1.9802922
(r/frandom my-prng 10.1 10.11) ;; => 10.102447
(r/drandom my-prng) ;; => 0.4648672564669125
(r/drandom my-prng 2.5) ;; => 2.4391674724067363
(r/drandom my-prng 10.1 10.11) ;; => 10.109255885124801
(r/grandom my-prng) ;; => -1.1376167481939505
(r/grandom my-prng 20.0) ;; => 12.953974636711065
(r/grandom my-prng 10.0 20.0) ;; => -16.376654909225724
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.9229791407310042 0.12649340257360553)
(r/->seq my-prng 2) ;; => (0.9182950794449085 0.615551669690412)
(r/->seq my-prng 5 :antithetic) ;; => (0.7792954319987684 0.22070456800123162 0.9686170126695577 0.031382987330442313 0.9398688724065751)
(r/->seq my-prng 5 :uniform) ;; => (0.20031684692473212 0.22073947599109622 0.25240969854099043 0.3984723239814754 0.6745926640550163)
(r/->seq my-prng 5 :systematic) ;; => (0.16025911207927798 0.36025911207927797 0.560259112079278 0.760259112079278 0.960259112079278)
(r/->seq my-prng 5 :stratified) ;; => (0.04393480609500449 0.21869514456582795 0.4678343618529689 0.7132619682804715 0.8933740930358791)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x5f7c5545 "org.apache.commons.math3.random.ISAACRandom@5f7c5545"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x74495b0c "org.apache.commons.math3.random.ISAACRandom@74495b0c"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x4c4b08ed "org.apache.commons.math3.random.JDKRandomGenerator@4c4b08ed"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x1e196806 "org.apache.commons.math3.random.JDKRandomGenerator@1e196806"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x2693e0f2 "org.apache.commons.math3.random.JDKRandomGenerator@2693e0f2"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x4c4b08ed "org.apache.commons.math3.random.JDKRandomGenerator@4c4b08ed"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x4c4b08ed "org.apache.commons.math3.random.JDKRandomGenerator@4c4b08ed"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x6806ee4a "org.apache.commons.math3.distribution.CauchyDistribution@6806ee4a"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x620df615 "org.apache.commons.math3.distribution.CauchyDistribution@620df615"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 4.733063966876887
(r/frandom log-logistic) ;; => 15.502979
(r/lrandom log-logistic) ;; => 7
(r/irandom log-logistic) ;; => 9
(r/sample log-logistic) ;; => 10.70580466579478
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.004408432995938472 0.12470132963124723 0.8708902373728143]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 15.116722867677202
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 12.110450624265958
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 18221.35973808569
...
(r/lrandom poisson) ;; => 17
(r/irandom poisson) ;; => 18
(r/sample poisson) ;; => 13
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 1.3126424122813627
(r/->seq weibull 3) ;; => (0.8455575544096939 0.6095761065885736 0.9250103187766903)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x2ed45a5e "org.apache.commons.math3.distribution.CauchyDistribution@2ed45a5e"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (0.1396107023277902 -1.949194640705265 -1.7454642816885013)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.3206561516981015 0.24420259178406106 0.43514125651783747]
(r/sample dirichlet3) ;; => [0.5094651859390034 0.12484763652595317 0.3656871775350434]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [8 20 36 44 42]
(r/sample multinomial) ;; => [6 18 30 43 53]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 2.001779680720405
(r/sample mixture-of-three) ;; => 4.738320477941038
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => 0.6662673895393558
(r/sample truncated-normal) ;; => 1.3327809433947166
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.7150007183952258
(r/sample kde-distr) ;; => 0.413359471485534
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 1.2820541708686466
(r/sample empirical-distr) ;; => 0.2049837232352125
...
(r/cdf cat-distr :b) ;; => 0.5600000000000002
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => ("s" :b :a)
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [-0.5972070959221314, -0.009358428510614357, 0.37360945831423287, 0.7096985818319009]
...
::: {.printedClojure}
```clojure
([0.3192535020555981 -0.22207911126993335 0.38882553966778033 0.14259341975397052 -0.25391948731633307 -0.33152946338299444 0.1400161366041712 -0.4512356334699222 0.10288389760925695 0.07818660581659385 -0.045272502721025745 -0.19909908130531714 -0.012260487735133456 -0.23395945062609574 -0.13955147398806977 0.31236060048707903 -0.036991049517361985 -0.0626472173036673 0.037345428510883884 0.20646500629139783] [0.08277578127393422 -0.1054154733375577 -0.5032554973487723 0.32063182365357196 0.2592542968468938 0.06676311609060971 0.24744444528474685 -0.023046527483933755 -0.31154935073955936 -0.15226809549382866 -0.17611403325185554 -0.14724515258214133 0.07212715269881738 0.15324137822121914 -0.18499178456363172 -0.2339787729946856 -0.15633431904833456 -0.03145279205685739 0.4190698898587969 0.029773893935727623])
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.38406887978263393
(r/vnoise 0.2 0.3) ;; => 0.4509442200507838
(r/vnoise 0.2 0.3 0.4) ;; => 0.5330686161269872
(r/noise 0.2) ;; => 0.5897970793650793
(r/noise 0.2 0.3) ;; => 0.46109110385777774
(r/noise 0.2 0.3 0.4) ;; => 0.5680868574215412
(r/simplex 0.2) ;; => 0.6538476661028572
(r/simplex 0.2 0.3) ;; => 0.6757377487257248
(r/simplex 0.2 0.3 0.4) ;; => 0.8202216401269842
```
:::
...
::: {.printedClojure}
```clojure
{:interpolation :quintic, :warp-scale 0.0, :seed 665844940, :normalize? true, :noise-type :simplex, :lacunarity 1.90872786462909, :gain 0.24908653479282347, :generator :ridgemulti, :warp-depth 1, :octaves 6}
...
::: {.printedClojure}
```clojure
{:interpolation :linear, :warp-scale 4.0, :seed 1, :normalize? true, :noise-type :gradient, :lacunarity 1.8874943472437105, :gain 0.508204375355278, :generator :ridgemulti, :warp-depth 1, :octaves 3}
...
+ `(billow-noise)`
+ `(billow-noise cfg__75683__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__75683__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__75683__auto__)`
