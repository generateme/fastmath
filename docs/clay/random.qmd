...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x526233d5 "org.apache.commons.math3.random.JDKRandomGenerator@526233d5"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => 502590705
(r/drandom (r/rng :mersenne) 0 10) ;; => 2.9406199985895687
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.21246901993789336 0.6844781640296773 0.026097246527027274)
(r/->seq (r/rng :mersenne) 3) ;; => (0.8761884589703575 0.6260100784911788 0.42540487396832627)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x288a6095 "org.apache.commons.math3.random.ISAACRandom@288a6095"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x7285468d "org.apache.commons.math3.random.ISAACRandom@7285468d"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x482980c7 "org.apache.commons.math3.random.SynchronizedRandomGenerator@482980c7"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 127054678
(r/irandom my-prng 5) ;; => 3
(r/irandom my-prng 10 20) ;; => 14
(r/lrandom my-prng) ;; => 3684464267993296820
(r/lrandom my-prng 5) ;; => 0
(r/lrandom my-prng 10 20) ;; => 17
(r/frandom my-prng) ;; => 0.01079011
(r/frandom my-prng 2.5) ;; => 0.5462265
(r/frandom my-prng 10.1 10.11) ;; => 10.103425
(r/drandom my-prng) ;; => 0.7220830754837768
(r/drandom my-prng 2.5) ;; => 1.5643359877130263
(r/drandom my-prng 10.1 10.11) ;; => 10.10309876368345
(r/grandom my-prng) ;; => -0.2361585652904375
(r/grandom my-prng 20.0) ;; => 6.052999190541471
(r/grandom my-prng 10.0 20.0) ;; => -3.1682881613371876
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.8105685543603662 0.8105737942503728)
(r/->seq my-prng 2) ;; => (0.6501124244596794 0.9606346992979158)
(r/->seq my-prng 5 :antithetic) ;; => (0.39131635435567347 0.6086836456443265 0.6113627093410132 0.3886372906589868 0.9777547787121643)
(r/->seq my-prng 5 :uniform) ;; => (0.3525805652685189 0.4042433462200678 0.7930824188585566 0.8075669685696967 0.8099919965664327)
(r/->seq my-prng 5 :systematic) ;; => (0.1384067224939871 0.3384067224939871 0.5384067224939871 0.7384067224939872 0.9384067224939872)
(r/->seq my-prng 5 :stratified) ;; => (0.04331675904541599 0.21552107033287995 0.5138247415503087 0.7265560639380916 0.9567426817296205)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x13e1621 "org.apache.commons.math3.random.ISAACRandom@13e1621"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x2cb630f8 "org.apache.commons.math3.random.ISAACRandom@2cb630f8"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x526233d5 "org.apache.commons.math3.random.JDKRandomGenerator@526233d5"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x13c24038 "org.apache.commons.math3.random.JDKRandomGenerator@13c24038"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x10c16321 "org.apache.commons.math3.random.JDKRandomGenerator@10c16321"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x526233d5 "org.apache.commons.math3.random.JDKRandomGenerator@526233d5"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x526233d5 "org.apache.commons.math3.random.JDKRandomGenerator@526233d5"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x47db76ae "org.apache.commons.math3.distribution.CauchyDistribution@47db76ae"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0xfccba4a "org.apache.commons.math3.distribution.CauchyDistribution@fccba4a"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 9.031022001836053
(r/frandom log-logistic) ;; => 8.218705
(r/lrandom log-logistic) ;; => 19
(r/irandom log-logistic) ;; => 8
(r/sample log-logistic) ;; => 9.832013534853111
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.13191467718782962 0.7132068620769705 0.15487846073519973]
(reduce + (r/sample dirichlet)) ;; => 0.9999999999999998
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 13.74625420474672
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 13.81987036459504
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 39199.43255329037
...
::: {.sourceClojure}
```clojure
(r/drandom poisson) ;; => 12.0
(r/frandom poisson) ;; => 12.0
(r/lrandom poisson) ;; => 11
(r/irandom poisson) ;; => 12
(r/sample poisson) ;; => 14
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.6127760642455408
(r/->seq weibull 3) ;; => (0.49488800573836544 1.5849311933826888 1.1662452693296292)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x715803a8 "org.apache.commons.math3.distribution.CauchyDistribution@715803a8"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (0.6267962835625627 1.3460964066508296 0.6267183683670784)
...
## ERR
```
Feb 16, 2026 10:11:03 PM clojure.tools.logging$eval56375$fn__56378 invoke
INFO: [:clojisr.v1.session/gc-clean-r-objects {:objects-before 9305, :objects-after 3413}]
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.1396836962836128 0.031240439884830717 0.8290758638315566]
(r/sample dirichlet3) ;; => [0.2494275653465827 0.18344498844303156 0.5671274462103857]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [6 16 35 41 52]
(r/sample multinomial) ;; => [16 26 32 41 35]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 14.037423830364895
(r/sample mixture-of-three) ;; => 3.1015108882336846
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.8968548296586177
(r/sample truncated-normal) ;; => -0.5151990457115051
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.5593832004061939
(r/sample kde-distr) ;; => 0.5869492589610822
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => -1.1798095844183702
(r/sample empirical-distr) ;; => 0.6536963339158824
...
(r/cdf cat-distr :b) ;; => 0.7400000000000002
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [-0.7346922684957724, -0.362092576189974, -0.1782490325813066, -0.5452921412091616]
...
::: {.printedClojure}
```clojure
([-0.1804172674595363 -0.06273754968059621 0.01791340405900236 -0.09560077357992017 0.2645974817831799 0.2095480258383854 0.4078887865121675 -0.30404291144719353 0.11134957137802969 -0.09889759485509286 0.2802961083548136 -0.2968412043643623 0.1988500882538137 -0.515499268574203 -0.0500573188243812 0.14018345667736176 0.14436200840488694 0.11922481099064912 0.12441820029026102 -0.12034434254087016] [-0.12586037917997622 -0.09782674934804318 0.2875332611915038 0.19121479599566887 0.17929849046288643 0.058582462231338964 -0.20196597023507848 0.24849776292468984 -0.1038726752081437 0.0059091446484580345 0.09515622058854295 0.5381054488612547 0.29258466883821294 -0.25304277538353237 0.06863921308208648 0.05744038475550412 -0.056724181679451646 0.1461825852795548 -0.3763670654932556 0.28966604673974883])
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.7832483902135721
(r/vnoise 0.2 0.3) ;; => 0.5310921996018432
(r/vnoise 0.2 0.3 0.4) ;; => 0.4546054916498654
(r/noise 0.2) ;; => 0.37411911111111107
(r/noise 0.2 0.3) ;; => 0.5155365050920635
(r/noise 0.2 0.3 0.4) ;; => 0.5004393375358847
(r/simplex 0.2) ;; => 0.3885385250133333
(r/simplex 0.2 0.3) ;; => 0.4658550811934377
(r/simplex 0.2 0.3 0.4) ;; => 0.5160886745396824
```
:::
...
::: {.printedClojure}
```clojure
{:interpolation :linear, :warp-scale 0.0, :seed 665844940, :normalize? true, :noise-type :gradient, :lacunarity 1.90872786462909, :gain 0.24908653479282347, :generator :billow, :warp-depth 1, :octaves 6}
...
::: {.printedClojure}
```clojure
{:interpolation :hermite, :warp-scale 4.0, :seed 1, :normalize? true, :noise-type :gradient, :lacunarity 1.8874943472437105, :gain 0.508204375355278, :generator :single, :warp-depth 1, :octaves 3}
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.6626399315147314
(some-random-noise 0.2 0.3) ;; => 0.05196402984684329
(some-random-noise 0.2 0.3 0.4) ;; => 0.36913708316274724
```
:::
...
+ `(billow-noise)`
+ `(billow-noise cfg__22522__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__22522__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__22522__auto__)`
