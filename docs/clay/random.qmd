...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x125e032a "org.apache.commons.math3.random.JDKRandomGenerator@125e032a"]
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">irandom</code></pre></div></td><td>random integer, returns long</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">lrandom</code></pre></div></td><td>random long</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">frandom</code></pre></div></td><td>random float, returns boxed float</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">drandom</code></pre></div></td><td>random double</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">-&gt;seq</code></pre></div></td><td>sequence of random doubles, sampling</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">set-seed!</code></pre></div></td><td>sets seed, possibly mutating, returns PRNG or distribution object</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">set-seed</code></pre></div></td><td>creates new instance with given seed</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">rng</code></pre></div></td><td>Create PRNG with optional seed</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">synced-rng</code></pre></div></td><td>Wrap PRNG to ensure thread safety</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x458d6888 "org.apache.commons.math3.random.ISAACRandom@458d6888"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x4d0e5b0b "org.apache.commons.math3.random.ISAACRandom@4d0e5b0b"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x382f5fb8 "org.apache.commons.math3.random.SynchronizedRandomGenerator@382f5fb8"]
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">grandom</code></pre></div></td><td>random gaussian</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">brandom</code></pre></div></td><td>random boolean</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 455174229
(r/irandom my-prng 5) ;; => 2
(r/irandom my-prng 10 20) ;; => 13
(r/lrandom my-prng) ;; => 8305343593572555149
(r/lrandom my-prng 5) ;; => 0
(r/lrandom my-prng 10 20) ;; => 11
(r/frandom my-prng) ;; => 0.64220655
(r/frandom my-prng 2.5) ;; => 1.9439763
(r/frandom my-prng 10.1 10.11) ;; => 10.107388
(r/drandom my-prng) ;; => 0.16969396152550775
(r/drandom my-prng 2.5) ;; => 2.169999316588439
(r/drandom my-prng 10.1 10.11) ;; => 10.101568579522086
(r/grandom my-prng) ;; => -1.389655297267027
(r/grandom my-prng 20.0) ;; => -3.4475426372107836
(r/grandom my-prng 10.0 20.0) ;; => 26.749940842172254
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.2695232984080389 0.4876430896518895)
(r/->seq my-prng 2) ;; => (0.12725015761617797 0.9759827207525451)
(r/->seq my-prng 5 :antithetic) ;; => (0.4818697515105228 0.5181302484894772 0.4972785762756886 0.5027214237243114 0.6918776856112852)
(r/->seq my-prng 5 :uniform) ;; => (0.119250116841303 0.15713179103726052 0.5007760529205386 0.6235870695158976 0.699730474180551)
(r/->seq my-prng 5 :systematic) ;; => (0.09985422997251621 0.2998542299725162 0.4998542299725163 0.6998542299725163 0.8998542299725163)
(r/->seq my-prng 5 :stratified) ;; => (0.05050413252367134 0.2282362236890769 0.5072591802744121 0.6881901760595488 0.9407395934572513)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x1b8e0d20 "org.apache.commons.math3.random.ISAACRandom@1b8e0d20"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x166c2630 "org.apache.commons.math3.random.ISAACRandom@166c2630"]
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">irand</code></pre></div></td><td>random integer, as long</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">lrand</code></pre></div></td><td>random long</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">frand</code></pre></div></td><td>random float as boxed Float</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">drand</code></pre></div></td><td>random double</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">grand</code></pre></div></td><td>random gaussian</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">brand</code></pre></div></td><td>random boolean</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">-&gt;seq</code></pre></div></td><td>returns infinite lazy sequence</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">set-seed</code></pre></div></td><td>seeds default-rng, returns new instance</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">set-seed!</code></pre></div></td><td>seeds default-rng and Smile's RNG</td></tr></tbody></table>
```
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x125e032a "org.apache.commons.math3.random.JDKRandomGenerator@125e032a"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0xe78fb6e "org.apache.commons.math3.random.JDKRandomGenerator@e78fb6e"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x537975cd "org.apache.commons.math3.random.JDKRandomGenerator@537975cd"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x125e032a "org.apache.commons.math3.random.JDKRandomGenerator@125e032a"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x125e032a "org.apache.commons.math3.random.JDKRandomGenerator@125e032a"]
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">randval</code></pre></div></td><td>A macro, returns value with given probability (default true/false with prob=0.5)</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">flip</code></pre></div></td><td>Returns 1 with given probability (or 0)</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">flipb</code></pre></div></td><td>Returns true with given probability</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">roll-a-dice</code></pre></div></td><td>Returns a result of rolling a n-sides dice(s)</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">randval-rng</code></pre></div></td><td>A macro, returns value with given probability (default true/false with prob=0.5)</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">flip-rng</code></pre></div></td><td>Returns 1 with given probability (or 0)</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">flipb-rng</code></pre></div></td><td>Returns true with given probability</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">roll-a-dice-rng</code></pre></div></td><td>Returns a result of rolling a n-sides dice(s)</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">distribution</code></pre></div></td><td>Distribution creator, a multimethod</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x64996a20 "org.apache.commons.math3.distribution.CauchyDistribution@64996a20"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0xfbe61a5 "org.apache.commons.math3.distribution.CauchyDistribution@fbe61a5"]
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">distribution?</code></pre></div></td><td>checks if given object is a distribution</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">pdf</code></pre></div></td><td>probability density (for continuous) or probability mass (for discrete)</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">lpdf</code></pre></div></td><td>log of pdf</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">observe1</code></pre></div></td><td>log of pdf, alias of lpdf</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">cdf</code></pre></div></td><td>cumulative density or probability, distribution</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">ccdf</code></pre></div></td><td>complementary cdf, 1-cdf</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">icdf</code></pre></div></td><td>inverse cdf, quantiles</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">sample</code></pre></div></td><td>returns random sample</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">dimensions</code></pre></div></td><td>number of dimensions</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">continuous?</code></pre></div></td><td>is distribution continuous (true) or discrete (false)?</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">log-likelihood</code></pre></div></td><td>sum of lpdfs for given seq of samples</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">observe</code></pre></div></td><td>macro version of log-likelihood</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">likelihood</code></pre></div></td><td>exp of log-likelihood</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">mean</code></pre></div></td><td>distribution mean</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">means</code></pre></div></td><td>distribution means for multivariate distributions</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">variance</code></pre></div></td><td>distribution variance</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">covariance</code></pre></div></td><td>covariance for multivariate distributions</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">lower-bound</code></pre></div></td><td>support lower bound</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">upper-bound</code></pre></div></td><td>support upper bound</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">distribution-id</code></pre></div></td><td>name of distribution</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">distribution-parameters</code></pre></div></td><td>list of parameters</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">integrate-pdf</code></pre></div></td><td>construct cdf and icdf out of pdf function</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 11.480831240946756
(r/frandom log-logistic) ;; => 5.579531
(r/lrandom log-logistic) ;; => 11
(r/irandom log-logistic) ;; => 11
(r/sample log-logistic) ;; => 3.6038192926674424
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.11548648360228615 0.19712496004117566 0.6873885563565383]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 12.859079201149505
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 14.446108905854214
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 2.6818554249660652E7
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">pdf-func</code></pre></div></td><td>PDF, univariate double->double function</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:mn</code></pre></div></td><td>lower bound, value of PDF(mn) should be 0.0</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:mx</code></pre></div></td><td>upper bound</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:steps</code></pre></div></td><td>number of subintervals</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:min-iterations</code></pre></div></td><td>minimum number of Romberg integrator iterations (default: 3, minimum 2)</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:interpolator</code></pre></div></td><td>one of: `:linear` (default), `:spline`, `:monotone` or any `fastmath.interpolator` method</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 1.078444843936788
(r/->seq weibull 3) ;; => (1.222468464187552 0.9625206430337994 0.695108003419516)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x67102e1d "org.apache.commons.math3.distribution.CauchyDistribution@67102e1d"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">default-normal</code></pre></div></td><td>public var which is a normal distribution N(0,1), thread-safe</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (0.9197931519563896 0.383566276481942 0.49076746179611647)
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 5}
</code></pre></div></td></tr><tr><td><div><img class="clay-image" src="random_files/0.png" /><img class="clay-image" src="random_files/1.png" /><img class="clay-image" src="random_files/2.png" /></div></td><td><div><img class="clay-image" src="random_files/3.png" /><img class="clay-image" src="random_files/4.png" /><img class="clay-image" src="random_files/5.png" /></div></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 1, :beta 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 0.5, :beta 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/6.png" /></td><td><img class="clay-image" src="random_files/7.png" /></td><td><img class="clay-image" src="random_files/8.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/9.png" /></td><td><img class="clay-image" src="random_files/10.png" /></td><td><img class="clay-image" src="random_files/11.png" /></td></tr></tbody></table></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 3, :beta 3}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 5, :beta 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/12.png" /></td><td><img class="clay-image" src="random_files/13.png" /></td><td><img class="clay-image" src="random_files/14.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/15.png" /></td><td><img class="clay-image" src="random_files/16.png" /></td><td><img class="clay-image" src="random_files/17.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:median 0, :scale 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:median 1, :scale 0.5}
</code></pre></div></td></tr><tr><td><div><img class="clay-image" src="random_files/18.png" /><img class="clay-image" src="random_files/19.png" /><img class="clay-image" src="random_files/20.png" /></div></td><td><div><img class="clay-image" src="random_files/21.png" /><img class="clay-image" src="random_files/22.png" /><img class="clay-image" src="random_files/23.png" /></div></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:nu 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:nu 3}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/24.png" /></td><td><img class="clay-image" src="random_files/25.png" /></td><td><img class="clay-image" src="random_files/26.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/27.png" /></td><td><img class="clay-image" src="random_files/28.png" /></td><td><img class="clay-image" src="random_files/29.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:degrees-of-freedom 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:degrees-of-freedom 3}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/30.png" /></td><td><img class="clay-image" src="random_files/31.png" /></td><td><img class="clay-image" src="random_files/32.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/33.png" /></td><td><img class="clay-image" src="random_files/34.png" /></td><td><img class="clay-image" src="random_files/35.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:nu 1, :lambda 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:nu 3, :lambda 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/36.png" /></td><td><img class="clay-image" src="random_files/37.png" /></td><td><img class="clay-image" src="random_files/38.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/39.png" /></td><td><img class="clay-image" src="random_files/40.png" /></td><td><img class="clay-image" src="random_files/41.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:k 1, :lambda 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:k 7, :lambda 2.0}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/48.png" /></td><td><img class="clay-image" src="random_files/49.png" /></td><td><img class="clay-image" src="random_files/50.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/51.png" /></td><td><img class="clay-image" src="random_files/52.png" /></td><td><img class="clay-image" src="random_files/53.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :sigma 1, :nu 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu -2, :sigma 0.5, :nu 4}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/54.png" /></td><td><img class="clay-image" src="random_files/55.png" /></td><td><img class="clay-image" src="random_files/56.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/57.png" /></td><td><img class="clay-image" src="random_files/58.png" /></td><td><img class="clay-image" src="random_files/59.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mean 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mean 3}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/60.png" /></td><td><img class="clay-image" src="random_files/61.png" /></td><td><img class="clay-image" src="random_files/62.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/63.png" /></td><td><img class="clay-image" src="random_files/64.png" /></td><td><img class="clay-image" src="random_files/65.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:numerator-degrees-of-freedom 1, :denominator-degrees-of-freedom 1}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/66.png" /></td><td><img class="clay-image" src="random_files/67.png" /></td><td><img class="clay-image" src="random_files/68.png" /></td></tr></tbody></table></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:numerator-degrees-of-freedom 10, :denominator-degrees-of-freedom 15}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/69.png" /></td><td><img class="clay-image" src="random_files/70.png" /></td><td><img class="clay-image" src="random_files/71.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :beta 1, :gamma 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu -1, :beta 3, :gamma 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/72.png" /></td><td><img class="clay-image" src="random_files/73.png" /></td><td><img class="clay-image" src="random_files/74.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/75.png" /></td><td><img class="clay-image" src="random_files/76.png" /></td><td><img class="clay-image" src="random_files/77.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :sigma 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 2, :sigma 1}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/78.png" /></td><td><img class="clay-image" src="random_files/79.png" /></td><td><img class="clay-image" src="random_files/80.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/81.png" /></td><td><img class="clay-image" src="random_files/82.png" /></td><td><img class="clay-image" src="random_files/83.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:delta 0, :alpha 1, :beta 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:delta 1, :alpha 3, :beta 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/84.png" /></td><td><img class="clay-image" src="random_files/85.png" /></td><td><img class="clay-image" src="random_files/86.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/87.png" /></td><td><img class="clay-image" src="random_files/88.png" /></td><td><img class="clay-image" src="random_files/89.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:shape 2, :scale 2}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:shape 5, :scale 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/90.png" /></td><td><img class="clay-image" src="random_files/91.png" /></td><td><img class="clay-image" src="random_files/92.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/93.png" /></td><td><img class="clay-image" src="random_files/94.png" /></td><td><img class="clay-image" src="random_files/95.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :beta 2}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :beta 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/96.png" /></td><td><img class="clay-image" src="random_files/97.png" /></td><td><img class="clay-image" src="random_files/98.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/99.png" /></td><td><img class="clay-image" src="random_files/100.png" /></td><td><img class="clay-image" src="random_files/101.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:scale 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:scale 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/102.png" /></td><td><img class="clay-image" src="random_files/103.png" /></td><td><img class="clay-image" src="random_files/104.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/105.png" /></td><td><img class="clay-image" src="random_files/106.png" /></td><td><img class="clay-image" src="random_files/107.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:sigma 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:sigma 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/108.png" /></td><td><img class="clay-image" src="random_files/109.png" /></td><td><img class="clay-image" src="random_files/110.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/111.png" /></td><td><img class="clay-image" src="random_files/112.png" /></td><td><img class="clay-image" src="random_files/113.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :sigma 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :sigma 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/114.png" /></td><td><img class="clay-image" src="random_files/115.png" /></td><td><img class="clay-image" src="random_files/116.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/117.png" /></td><td><img class="clay-image" src="random_files/118.png" /></td><td><img class="clay-image" src="random_files/119.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:lambdas [1]}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:lambdas [1 2 3 4 1]}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/120.png" /></td><td><img class="clay-image" src="random_files/121.png" /></td><td><img class="clay-image" src="random_files/122.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/123.png" /></td><td><img class="clay-image" src="random_files/124.png" /></td><td><img class="clay-image" src="random_files/125.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 1, :k 1, :h 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 5, :h 0.5, :k 6}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/126.png" /></td><td><img class="clay-image" src="random_files/127.png" /></td><td><img class="clay-image" src="random_files/128.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/129.png" /></td><td><img class="clay-image" src="random_files/130.png" /></td><td><img class="clay-image" src="random_files/131.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 2, :beta 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 1.5, :beta 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/132.png" /></td><td><img class="clay-image" src="random_files/133.png" /></td><td><img class="clay-image" src="random_files/134.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/135.png" /></td><td><img class="clay-image" src="random_files/136.png" /></td><td><img class="clay-image" src="random_files/137.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :lambda 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 2, :lambda 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/138.png" /></td><td><img class="clay-image" src="random_files/139.png" /></td><td><img class="clay-image" src="random_files/140.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/141.png" /></td><td><img class="clay-image" src="random_files/142.png" /></td><td><img class="clay-image" src="random_files/143.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:gamma 0, :delta 1, :xi 0, :lambda 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:gamma 0.5, :delta 2, :xi 0, :lambda 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/144.png" /></td><td><img class="clay-image" src="random_files/145.png" /></td><td><img class="clay-image" src="random_files/146.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/147.png" /></td><td><img class="clay-image" src="random_files/148.png" /></td><td><img class="clay-image" src="random_files/149.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/150.png" /></td><td><img class="clay-image" src="random_files/151.png" /></td><td><img class="clay-image" src="random_files/152.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/153.png" /></td><td><img class="clay-image" src="random_files/154.png" /></td><td><img class="clay-image" src="random_files/155.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/156.png" /></td><td><img class="clay-image" src="random_files/157.png" /></td><td><img class="clay-image" src="random_files/158.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/159.png" /></td><td><img class="clay-image" src="random_files/160.png" /></td><td><img class="clay-image" src="random_files/161.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<div><p>[</p><div class="clay-sequential" style="margin-left:10%;width:110%;"><img class="clay-image" src="random_files/162.png" /><img class="clay-image" src="random_files/163.png" /><img class="clay-image" src="random_files/164.png" /></div><p>]</p></div>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 10}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/165.png" /></td><td><img class="clay-image" src="random_files/166.png" /></td><td><img class="clay-image" src="random_files/167.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/168.png" /></td><td><img class="clay-image" src="random_files/169.png" /></td><td><img class="clay-image" src="random_files/170.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/171.png" /></td><td><img class="clay-image" src="random_files/172.png" /></td><td><img class="clay-image" src="random_files/173.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/174.png" /></td><td><img class="clay-image" src="random_files/175.png" /></td><td><img class="clay-image" src="random_files/176.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :beta 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :beta 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/177.png" /></td><td><img class="clay-image" src="random_files/178.png" /></td><td><img class="clay-image" src="random_files/179.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/180.png" /></td><td><img class="clay-image" src="random_files/181.png" /></td><td><img class="clay-image" src="random_files/182.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :c 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :c 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/183.png" /></td><td><img class="clay-image" src="random_files/184.png" /></td><td><img class="clay-image" src="random_files/185.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/186.png" /></td><td><img class="clay-image" src="random_files/187.png" /></td><td><img class="clay-image" src="random_files/188.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 3, :beta 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 5, :beta 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/189.png" /></td><td><img class="clay-image" src="random_files/190.png" /></td><td><img class="clay-image" src="random_files/191.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/192.png" /></td><td><img class="clay-image" src="random_files/193.png" /></td><td><img class="clay-image" src="random_files/194.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:scale 1, :shape 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:scale 2, :shape 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/195.png" /></td><td><img class="clay-image" src="random_files/196.png" /></td><td><img class="clay-image" src="random_files/197.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/198.png" /></td><td><img class="clay-image" src="random_files/199.png" /></td><td><img class="clay-image" src="random_files/200.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :scale 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :scale 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/201.png" /></td><td><img class="clay-image" src="random_files/202.png" /></td><td><img class="clay-image" src="random_files/203.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/204.png" /></td><td><img class="clay-image" src="random_files/205.png" /></td><td><img class="clay-image" src="random_files/206.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :omega 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.5, :omega 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/207.png" /></td><td><img class="clay-image" src="random_files/208.png" /></td><td><img class="clay-image" src="random_files/209.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/210.png" /></td><td><img class="clay-image" src="random_files/211.png" /></td><td><img class="clay-image" src="random_files/212.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :sd 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.5, :sd 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/213.png" /></td><td><img class="clay-image" src="random_files/214.png" /></td><td><img class="clay-image" src="random_files/215.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/216.png" /></td><td><img class="clay-image" src="random_files/217.png" /></td><td><img class="clay-image" src="random_files/218.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/223.png" /></td><td><img class="clay-image" src="random_files/224.png" /></td><td><img class="clay-image" src="random_files/225.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/226.png" /></td><td><img class="clay-image" src="random_files/227.png" /></td><td><img class="clay-image" src="random_files/228.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha1 1, :alpha2 1, :beta 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:scale 2, :shape 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/229.png" /></td><td><img class="clay-image" src="random_files/230.png" /></td><td><img class="clay-image" src="random_files/231.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/232.png" /></td><td><img class="clay-image" src="random_files/233.png" /></td><td><img class="clay-image" src="random_files/234.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:a 0, :b 1, :c 2}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:a 1, :b 2, :c 1.25}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/235.png" /></td><td><img class="clay-image" src="random_files/236.png" /></td><td><img class="clay-image" src="random_files/237.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/238.png" /></td><td><img class="clay-image" src="random_files/239.png" /></td><td><img class="clay-image" src="random_files/240.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/241.png" /></td><td><img class="clay-image" src="random_files/242.png" /></td><td><img class="clay-image" src="random_files/243.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/244.png" /></td><td><img class="clay-image" src="random_files/245.png" /></td><td><img class="clay-image" src="random_files/246.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:a 0.5}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:a 2}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/247.png" /></td><td><img class="clay-image" src="random_files/248.png" /></td><td><img class="clay-image" src="random_files/249.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/250.png" /></td><td><img class="clay-image" src="random_files/251.png" /></td><td><img class="clay-image" src="random_files/252.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:degrees-of-freedom 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:degrees-of-freedom 50}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/253.png" /></td><td><img class="clay-image" src="random_files/254.png" /></td><td><img class="clay-image" src="random_files/255.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/256.png" /></td><td><img class="clay-image" src="random_files/257.png" /></td><td><img class="clay-image" src="random_files/258.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:a -1, :b 1, :c 0}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:a -0.5, :b 1, :c 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/259.png" /></td><td><img class="clay-image" src="random_files/260.png" /></td><td><img class="clay-image" src="random_files/261.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/262.png" /></td><td><img class="clay-image" src="random_files/263.png" /></td><td><img class="clay-image" src="random_files/264.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:lower 0, :upper 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:lower -1, :upper 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/265.png" /></td><td><img class="clay-image" src="random_files/266.png" /></td><td><img class="clay-image" src="random_files/267.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/268.png" /></td><td><img class="clay-image" src="random_files/269.png" /></td><td><img class="clay-image" src="random_files/270.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 2}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:n 10}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/271.png" /></td><td><img class="clay-image" src="random_files/272.png" /></td><td><img class="clay-image" src="random_files/273.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/274.png" /></td><td><img class="clay-image" src="random_files/275.png" /></td><td><img class="clay-image" src="random_files/276.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/277.png" /></td><td><img class="clay-image" src="random_files/278.png" /></td><td><img class="clay-image" src="random_files/279.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/280.png" /></td><td><img class="clay-image" src="random_files/281.png" /></td><td><img class="clay-image" src="random_files/282.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 2, :beta 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 1.2, :beta 0.8}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/283.png" /></td><td><img class="clay-image" src="random_files/284.png" /></td><td><img class="clay-image" src="random_files/285.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/286.png" /></td><td><img class="clay-image" src="random_files/287.png" /></td><td><img class="clay-image" src="random_files/288.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0, :sigma 1, :nu 0.1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :sigma 1, :nu 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/289.png" /></td><td><img class="clay-image" src="random_files/290.png" /></td><td><img class="clay-image" src="random_files/291.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/292.png" /></td><td><img class="clay-image" src="random_files/293.png" /></td><td><img class="clay-image" src="random_files/294.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.5, :sigma 1, :bd 10}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.65, :sigma 0.3, :bd 20}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/295.png" /></td><td><img class="clay-image" src="random_files/296.png" /></td><td><img class="clay-image" src="random_files/297.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/298.png" /></td><td><img class="clay-image" src="random_files/299.png" /></td><td><img class="clay-image" src="random_files/300.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:p 0.5}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:p 0.25}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/301.png" /></td><td><img class="clay-image" src="random_files/302.png" /></td><td><img class="clay-image" src="random_files/303.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/304.png" /></td><td><img class="clay-image" src="random_files/305.png" /></td><td><img class="clay-image" src="random_files/306.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:trials 20, :p 0.5}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:trials 50, :p 0.25}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/307.png" /></td><td><img class="clay-image" src="random_files/308.png" /></td><td><img class="clay-image" src="random_files/309.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/310.png" /></td><td><img class="clay-image" src="random_files/311.png" /></td><td><img class="clay-image" src="random_files/312.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:ns 10, :nf 10, :n 5, :omega 1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:ns 30, :nf 60, :n 20, :omega 0.75}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/313.png" /></td><td><img class="clay-image" src="random_files/314.png" /></td><td><img class="clay-image" src="random_files/315.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/316.png" /></td><td><img class="clay-image" src="random_files/317.png" /></td><td><img class="clay-image" src="random_files/318.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:p 0.5}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:p 0.15}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/319.png" /></td><td><img class="clay-image" src="random_files/320.png" /></td><td><img class="clay-image" src="random_files/321.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/322.png" /></td><td><img class="clay-image" src="random_files/323.png" /></td><td><img class="clay-image" src="random_files/324.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:population-size 100, :number-of-successes 50, :sample-size 25}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/325.png" /></td><td><img class="clay-image" src="random_files/326.png" /></td><td><img class="clay-image" src="random_files/327.png" /></td></tr></tbody></table></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:population-size 2000, :number-of-successes 20, :sample-size 200}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/328.png" /></td><td><img class="clay-image" src="random_files/329.png" /></td><td><img class="clay-image" src="random_files/330.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:theta 0.5}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:theta 0.99}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/331.png" /></td><td><img class="clay-image" src="random_files/332.png" /></td><td><img class="clay-image" src="random_files/333.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/334.png" /></td><td><img class="clay-image" src="random_files/335.png" /></td><td><img class="clay-image" src="random_files/336.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:r 20, :p 0.5}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:r 100, :p 0.95}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:r 21.2345, :p 0.7}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/337.png" /></td><td><img class="clay-image" src="random_files/338.png" /></td><td><img class="clay-image" src="random_files/339.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/340.png" /></td><td><img class="clay-image" src="random_files/341.png" /></td><td><img class="clay-image" src="random_files/342.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/343.png" /></td><td><img class="clay-image" src="random_files/344.png" /></td><td><img class="clay-image" src="random_files/345.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/346.png" /></td><td><img class="clay-image" src="random_files/347.png" /></td><td><img class="clay-image" src="random_files/348.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/349.png" /></td><td><img class="clay-image" src="random_files/350.png" /></td><td><img class="clay-image" src="random_files/351.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:lower 0, :upper 20}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:lower -5, :upper 5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/358.png" /></td><td><img class="clay-image" src="random_files/359.png" /></td><td><img class="clay-image" src="random_files/360.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/361.png" /></td><td><img class="clay-image" src="random_files/362.png" /></td><td><img class="clay-image" src="random_files/363.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.5, :sigma 0.1, :bd 10, :nu 0.1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:nu 0.1, :mu 0.65, :sigma 0.3, :bd 20}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/364.png" /></td><td><img class="clay-image" src="random_files/365.png" /></td><td><img class="clay-image" src="random_files/366.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/367.png" /></td><td><img class="clay-image" src="random_files/368.png" /></td><td><img class="clay-image" src="random_files/369.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.5, :sigma 0.1, :bd 10}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.65, :sigma 0.3, :bd 20}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/370.png" /></td><td><img class="clay-image" src="random_files/371.png" /></td><td><img class="clay-image" src="random_files/372.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/373.png" /></td><td><img class="clay-image" src="random_files/374.png" /></td><td><img class="clay-image" src="random_files/375.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 1, :sigma 1, :nu 0.3}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:nu 0.1, :mu 2, :sigma 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/376.png" /></td><td><img class="clay-image" src="random_files/377.png" /></td><td><img class="clay-image" src="random_files/378.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/379.png" /></td><td><img class="clay-image" src="random_files/380.png" /></td><td><img class="clay-image" src="random_files/381.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 0.5, :sigma 0.5, :bd 10, :nu 0.1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:nu 0.1, :mu 0.65, :sigma 1, :bd 20}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/382.png" /></td><td><img class="clay-image" src="random_files/383.png" /></td><td><img class="clay-image" src="random_files/384.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/385.png" /></td><td><img class="clay-image" src="random_files/386.png" /></td><td><img class="clay-image" src="random_files/387.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/388.png" /></td><td><img class="clay-image" src="random_files/389.png" /></td><td><img class="clay-image" src="random_files/390.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/391.png" /></td><td><img class="clay-image" src="random_files/392.png" /></td><td><img class="clay-image" src="random_files/393.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/394.png" /></td><td><img class="clay-image" src="random_files/395.png" /></td><td><img class="clay-image" src="random_files/396.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/397.png" /></td><td><img class="clay-image" src="random_files/398.png" /></td><td><img class="clay-image" src="random_files/399.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 5, :sigma 0.1}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:mu 2, :sigma 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/400.png" /></td><td><img class="clay-image" src="random_files/401.png" /></td><td><img class="clay-image" src="random_files/402.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/403.png" /></td><td><img class="clay-image" src="random_files/404.png" /></td><td><img class="clay-image" src="random_files/405.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/406.png" /></td><td><img class="clay-image" src="random_files/407.png" /></td><td><img class="clay-image" src="random_files/408.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/409.png" /></td><td><img class="clay-image" src="random_files/410.png" /></td><td><img class="clay-image" src="random_files/411.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:number-of-elements 100, :exponent 3}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:number-of-elements 20, :exponent 0.5}
</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/412.png" /></td><td><img class="clay-image" src="random_files/413.png" /></td><td><img class="clay-image" src="random_files/414.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/415.png" /></td><td><img class="clay-image" src="random_files/416.png" /></td><td><img class="clay-image" src="random_files/417.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.466976567594134 0.42311989089958246 0.10990354150628358]
(r/sample dirichlet3) ;; => [0.8411587080742298 0.03006536497253119 0.12877592695323895]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [11 21 29 42 47]
(r/sample multinomial) ;; => [16 17 26 40 51]
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>three normals</td><td>gamma, laplace and log-logistic</td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/427.png" /></td><td><img class="clay-image" src="random_files/428.png" /></td><td><img class="clay-image" src="random_files/429.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/430.png" /></td><td><img class="clay-image" src="random_files/431.png" /></td><td><img class="clay-image" src="random_files/432.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 1.0289215629882789
(r/sample mixture-of-three) ;; => 0.561279275283213
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>name</th><th>parameters</th></tr></thead><tbody><tr><td>truncated</td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:distr :left :right :rng]
</code></pre></div></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>truncated normal</td><td>trucated levy (left side)</td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/433.png" /></td><td><img class="clay-image" src="random_files/434.png" /></td><td><img class="clay-image" src="random_files/435.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/436.png" /></td><td><img class="clay-image" src="random_files/437.png" /></td><td><img class="clay-image" src="random_files/438.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.7548283976981577
(r/sample truncated-normal) ;; => 0.06988061964898433
...
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:kde</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:data :steps :kde :bandwidth :rng]
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:empirical</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:rng :bin-count :data]
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:real-discrete-distribution</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:data :probabilities :rng]
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:integer-discrete-distribution</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:data :probabilities :rng]
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:categorical-distribution</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:data :probabilities :rng]
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:enumerated-real</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:rng :data :probabilities]
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:enumerated-int</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:data :probabilities :rng]
</code></pre></div></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>default</td><td>bandwidth=1.0</td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/439.png" /></td><td><img class="clay-image" src="random_files/440.png" /></td><td><img class="clay-image" src="random_files/441.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/442.png" /></td><td><img class="clay-image" src="random_files/443.png" /></td><td><img class="clay-image" src="random_files/444.png" /></td></tr></tbody></table></td></tr><tr><td>gaussian kernel</td><td>triangular kernel, bandwidth=0.1</td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/445.png" /></td><td><img class="clay-image" src="random_files/446.png" /></td><td><img class="clay-image" src="random_files/447.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/448.png" /></td><td><img class="clay-image" src="random_files/449.png" /></td><td><img class="clay-image" src="random_files/450.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.2012005763639136
(r/sample kde-distr) ;; => 4.958092924573209
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>default</td><td>bin-count=10</td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/493.png" /></td><td><img class="clay-image" src="random_files/494.png" /></td><td><img class="clay-image" src="random_files/495.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/496.png" /></td><td><img class="clay-image" src="random_files/497.png" /></td><td><img class="clay-image" src="random_files/498.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 3.4073575047898195
(r/sample empirical-distr) ;; => 1.3824435019415011
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:integer-discrete-distribution</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:enumerated-int</code></pre></div></td></tr><tr><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/505.png" /></td><td><img class="clay-image" src="random_files/506.png" /></td><td><img class="clay-image" src="random_files/507.png" /></td></tr></tbody></table></td><td><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/508.png" /></td><td><img class="clay-image" src="random_files/509.png" /></td><td><img class="clay-image" src="random_files/510.png" /></td></tr></tbody></table></td></tr></tbody></table>
```
...
(r/pdf cat-distr nil) ;; => 0.16
(r/pdf cat-distr "ss") ;; => 0.0
(r/cdf cat-distr :b) ;; => 1.0000000000000002
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => (nil "s" :b)
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">sequence-generator</code></pre></div></td><td>Lazy sequence of generated vectors (for dim>1) or primitives (for dim=1)</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">jittered-sequence-generator</code></pre></div></td><td>Adds jittering, works only for low discrepancy sequences</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [-0.3302907363058977, -0.2956735878128057, 0.5483820390931555, -0.7090573306725232]
...
([0.30994315746637535
  ...
  0.02632025725596054
  0.08952853399533901]
 [-0.055546627194238106
  0.07423947646864859
  -0.4472873254860393
  0.017068845193308698
  -0.04382800197267643
  -0.3106189333467401
  0.03213809511771947
  0.16166839144055564
  0.2906544772992155
  0.028129724964698326
  -0.26309888376622836
  0.3007406356709395
  0.1485627458907792
  0.2049401256328963
  0.026421136317892696
  -0.19262666713639065
  0.391339460286334
  -0.3489426668655491
  -0.02109366417160346
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>:default</td><td>:gaussian</td></tr><tr><td><img class="clay-image" src="random_files/519.png" /></td><td><img class="clay-image" src="random_files/520.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">single-noise</code></pre></div></td><td>single frequency (octave) noise</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">fbm-noise</code></pre></div></td><td>multi frequency (octaves), fractal brownian motion</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">billow-noise</code></pre></div></td><td>multi frequency, "billowy" noise</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">ridgemulti-noise</code></pre></div></td><td>multi frequency, ridged multi-fractal</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">vnoise</code></pre></div></td><td>FBM value noise, 6 octaves, hermite interpolation</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">noise</code></pre></div></td><td>Perlin noise, FBM gradient noise, 6 octaves, quintic interpolation</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">simplex</code></pre></div></td><td>FBM simplex noise</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>vnoise</td><td>noise</td><td>simplex</td></tr><tr><td><img class="clay-image" src="random_files/563.png" /></td><td><img class="clay-image" src="random_files/564.png" /></td><td><img class="clay-image" src="random_files/565.png" /></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.7565349840903781
(r/vnoise 0.2 0.3) ;; => 0.4953761850813492
(r/vnoise 0.2 0.3 0.4) ;; => 0.5381099869537125
(r/noise 0.2) ;; => 0.48960761904761907
(r/noise 0.2 0.3) ;; => 0.5115921637180952
(r/noise 0.2 0.3 0.4) ;; => 0.6069659999345258
(r/simplex 0.2) ;; => 0.46833813382095235
(r/simplex 0.2 0.3) ;; => 0.4236776541086313
(r/simplex 0.2 0.3 0.4) ;; => 0.35089493214814804
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">warp-noise-fn</code></pre></div></td><td>Create warp noise</td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td></td><td>vnoise</td><td>noise</td><td>simplex</td></tr><tr><td>scale=2</td><td><img class="clay-image" src="random_files/566.png" /></td><td><img class="clay-image" src="random_files/567.png" /></td><td><img class="clay-image" src="random_files/568.png" /></td></tr><tr><td>scale=4</td><td><img class="clay-image" src="random_files/569.png" /></td><td><img class="clay-image" src="random_files/570.png" /></td><td><img class="clay-image" src="random_files/571.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">random-noise-cfg</code></pre></div></td><td>Create random configuration</td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">random-noise-fn</code></pre></div></td><td>Create random noise from random configuration</td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.346627107824676
(some-random-noise 0.2 0.3) ;; => 0.8439477234886865
(some-random-noise 0.2 0.3 0.4) ;; => 0.8350485358458254
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><thead><tr><th>Symbol</th><th>Info</th></tr></thead><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">discrete-noise</code></pre></div></td><td>1d or 2d hashing function</td></tr></tbody></table>
```
...
+ `(billow-noise)`
+ `(billow-noise cfg__16519__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__16519__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__16519__auto__)`
