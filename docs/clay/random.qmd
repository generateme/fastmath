...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x675d1bf5 "org.apache.commons.math3.random.JDKRandomGenerator@675d1bf5"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => 1957574119
(r/drandom (r/rng :mersenne) 0 10) ;; => 5.670679348998431
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.884850437167948 0.8263255065148665 0.44786145250575715)
(r/->seq (r/rng :mersenne) 3) ;; => (0.05478059175262873 0.6831966549733168 0.23716845383045593)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x55c86d1c "org.apache.commons.math3.random.ISAACRandom@55c86d1c"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x7c4e7cd6 "org.apache.commons.math3.random.ISAACRandom@7c4e7cd6"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x1c092deb "org.apache.commons.math3.random.SynchronizedRandomGenerator@1c092deb"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 611201530
(r/irandom my-prng 5) ;; => 3
(r/irandom my-prng 10 20) ;; => 17
(r/lrandom my-prng) ;; => -5017782966369524146
(r/lrandom my-prng 5) ;; => 1
(r/lrandom my-prng 10 20) ;; => 14
(r/frandom my-prng) ;; => 0.4505129
(r/frandom my-prng 2.5) ;; => 1.0950434
(r/frandom my-prng 10.1 10.11) ;; => 10.107957
(r/drandom my-prng) ;; => 0.5004383492045907
(r/drandom my-prng 2.5) ;; => 0.9279383607041675
(r/drandom my-prng 10.1 10.11) ;; => 10.10741483056368
(r/grandom my-prng) ;; => -0.8475620914583533
(r/grandom my-prng 20.0) ;; => -13.373756592279877
(r/grandom my-prng 10.0 20.0) ;; => -11.701727836437222
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.15507409861853239 0.9819093584833192)
(r/->seq my-prng 2) ;; => (0.8949649903334105 0.05198685110401646)
(r/->seq my-prng 5 :antithetic) ;; => (0.09386074666705757 0.9061392533329424 0.7595976655483367 0.24040233445166326 0.6718369442920424)
(r/->seq my-prng 5 :uniform) ;; => (0.25794285239653675 0.3793587575596493 0.60134414765009 0.7208826946518191 0.8560935080814192)
(r/->seq my-prng 5 :systematic) ;; => (0.06701106417023132 0.26701106417023135 0.4670110641702314 0.6670110641702314 0.8670110641702314)
(r/->seq my-prng 5 :stratified) ;; => (0.10769473409513203 0.32851747068794634 0.48561395088019915 0.6725657162442058 0.8048635777044688)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x36e1ff76 "org.apache.commons.math3.random.ISAACRandom@36e1ff76"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x4f3029b8 "org.apache.commons.math3.random.ISAACRandom@4f3029b8"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x675d1bf5 "org.apache.commons.math3.random.JDKRandomGenerator@675d1bf5"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x573dbca1 "org.apache.commons.math3.random.JDKRandomGenerator@573dbca1"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x2e2ba6e4 "org.apache.commons.math3.random.JDKRandomGenerator@2e2ba6e4"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x675d1bf5 "org.apache.commons.math3.random.JDKRandomGenerator@675d1bf5"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x675d1bf5 "org.apache.commons.math3.random.JDKRandomGenerator@675d1bf5"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x2685a004 "org.apache.commons.math3.distribution.CauchyDistribution@2685a004"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x7f0ea6c3 "org.apache.commons.math3.distribution.CauchyDistribution@7f0ea6c3"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 6.748254518930999
(r/frandom log-logistic) ;; => 5.8466067
(r/lrandom log-logistic) ;; => 5
(r/irandom log-logistic) ;; => 2
(r/sample log-logistic) ;; => 7.8853307833114386
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.03264957214316936 0.35283281135549577 0.614517616501335]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 14.763717348623807
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 11.443498485562388
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 717539.4469529721
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 1.3380362892012558
(r/->seq weibull 3) ;; => (1.1637919986003287 0.4173041869955912 1.1227279783785078)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x42247863 "org.apache.commons.math3.distribution.CauchyDistribution@42247863"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (0.7944437327877528 1.4481057805268245 -0.42600352104975076)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.49696179135754104 0.10841447789571539 0.3946237307467435]
(r/sample dirichlet3) ;; => [0.7988961145213728 0.09848811890936757 0.10261576656925951]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [10 17 29 40 54]
(r/sample multinomial) ;; => [8 19 31 43 49]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 0.6610275643856927
(r/sample mixture-of-three) ;; => 4.539636001636375
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.8255489504711414
(r/sample truncated-normal) ;; => 0.30911554340798864
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.447102420413535
(r/sample kde-distr) ;; => -1.382073761526527
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 4.069895190372929
(r/sample empirical-distr) ;; => 1.9038021006215746
...
(r/cdf cat-distr :b) ;; => 0.7000000000000002
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => (:a :b "s")
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [0.9018596897074675, -0.034378856887985934, -0.31271129733619074, -0.2961061275930345]
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.5251201376861704
(r/vnoise 0.2 0.3) ;; => 0.5302616082743181
(r/vnoise 0.2 0.3 0.4) ;; => 0.5158299832097784
(r/noise 0.2) ;; => 0.5750872380952381
(r/noise 0.2 0.3) ;; => 0.5716913972825397
(r/noise 0.2 0.3 0.4) ;; => 0.33726167292266784
(r/simplex 0.2) ;; => 0.4193776692419048
(r/simplex 0.2 0.3) ;; => 0.7670225085649097
(r/simplex 0.2 0.3 0.4) ;; => 0.5534427922962962
```
:::
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.18210029531978383
(some-random-noise 0.2 0.3) ;; => 0.6109356794583682
(some-random-noise 0.2 0.3 0.4) ;; => 0.4867455574540818
```
:::
...
+ `(billow-noise)`
+ `(billow-noise cfg__15625__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__15625__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__15625__auto__)`
