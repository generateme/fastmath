...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x32e6ed09 "org.apache.commons.math3.random.JDKRandomGenerator@32e6ed09"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => 975846566
(r/drandom (r/rng :mersenne) 0 10) ;; => 1.05463270063751
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.2105831909800988 0.9211057829688141 0.022280467241009072)
(r/->seq (r/rng :mersenne) 3) ;; => (0.6002489712626644 0.4898769386857442 0.2981818676531909)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x3d538a07 "org.apache.commons.math3.random.ISAACRandom@3d538a07"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x51c196c5 "org.apache.commons.math3.random.ISAACRandom@51c196c5"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x404760bd "org.apache.commons.math3.random.SynchronizedRandomGenerator@404760bd"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => -2080456530
(r/irandom my-prng 5) ;; => 1
(r/irandom my-prng 10 20) ;; => 13
(r/lrandom my-prng) ;; => 4213967652277095664
(r/lrandom my-prng 5) ;; => 1
(r/lrandom my-prng 10 20) ;; => 13
(r/frandom my-prng) ;; => 0.9815366
(r/frandom my-prng 2.5) ;; => 2.2020602
(r/frandom my-prng 10.1 10.11) ;; => 10.100172
(r/drandom my-prng) ;; => 0.5436803040456928
(r/drandom my-prng 2.5) ;; => 1.658830321356266
(r/drandom my-prng 10.1 10.11) ;; => 10.104430543487435
(r/grandom my-prng) ;; => 1.0822599643306414
(r/grandom my-prng 20.0) ;; => 6.546076695350037
(r/grandom my-prng 10.0 20.0) ;; => -11.729051930479606
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.05470711853610832 0.4138382438809951)
(r/->seq my-prng 2) ;; => (0.14485162588897027 0.18257613422967034)
(r/->seq my-prng 5 :antithetic) ;; => (0.8922424505238591 0.10775754947614091 0.9182055842061498 0.08179441579385016 0.15961258350801688)
(r/->seq my-prng 5 :uniform) ;; => (0.01393284420656061 0.3075416559445313 0.5245351474386054 0.6970359982294326 0.8508075747911051)
(r/->seq my-prng 5 :systematic) ;; => (0.07182314136220143 0.2718231413622014 0.47182314136220144 0.6718231413622014 0.8718231413622015)
(r/->seq my-prng 5 :stratified) ;; => (0.04397524286419663 0.3969184427264185 0.594850790649147 0.7271146032467165 0.9320761521397527)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x644c7f74 "org.apache.commons.math3.random.ISAACRandom@644c7f74"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x5ea9cb86 "org.apache.commons.math3.random.ISAACRandom@5ea9cb86"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x32e6ed09 "org.apache.commons.math3.random.JDKRandomGenerator@32e6ed09"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x60fae7d0 "org.apache.commons.math3.random.JDKRandomGenerator@60fae7d0"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x7c3881f6 "org.apache.commons.math3.random.JDKRandomGenerator@7c3881f6"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x32e6ed09 "org.apache.commons.math3.random.JDKRandomGenerator@32e6ed09"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x32e6ed09 "org.apache.commons.math3.random.JDKRandomGenerator@32e6ed09"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x282202c3 "org.apache.commons.math3.distribution.CauchyDistribution@282202c3"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x6a8d1ffe "org.apache.commons.math3.distribution.CauchyDistribution@6a8d1ffe"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 21.190288893266416
(r/frandom log-logistic) ;; => 6.4579844
(r/lrandom log-logistic) ;; => 7
(r/irandom log-logistic) ;; => 17
(r/sample log-logistic) ;; => 8.037616142198578
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.11668799404975817 0.4940118316917886 0.3893001742584533]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 7.962846196773985
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 13.314262138332351
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 87166.95687986509
...
::: {.sourceClojure}
```clojure
(r/drandom poisson) ;; => 6.0
(r/frandom poisson) ;; => 18.0
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.5095366693884767
(r/->seq weibull 3) ;; => (0.33984991351958677 0.5220026542972168 0.5302445679066049)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x5caf1f59 "org.apache.commons.math3.distribution.CauchyDistribution@5caf1f59"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (0.8335078932119859 1.2037613492081487 1.384371001197184)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.37169537814520615 0.08338462888237412 0.5449199929724196]
(r/sample dirichlet3) ;; => [0.2025244631052037 0.19505037762739375 0.6024251592674026]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [14 12 37 38 49]
(r/sample multinomial) ;; => [12 21 28 38 51]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 3.410532376620632
(r/sample mixture-of-three) ;; => -0.048631244219572066
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => 0.06964320391605416
(r/sample truncated-normal) ;; => 0.550023011539513
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.09507010236650877
(r/sample kde-distr) ;; => 0.10932931343895971
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => -0.5053274475640136
(r/sample empirical-distr) ;; => -1.5385278888045695
...
(r/pdf cat-distr nil) ;; => 0.21000000000000005
(r/pdf cat-distr "ss") ;; => 0.0
(r/cdf cat-distr :b) ;; => 0.19000000000000003
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [-0.619525468321347, -0.3144984547748108, -0.6806028727941198, -0.23250515174908062]
...
::: {.printedClojure}
```clojure
([0.43389359004327493 -0.2719053125947137 -0.17445776246899486 -0.05870886275375964 0.2984620197261433 -0.25005015148736426 0.21065519485546946 0.06482001211616295 -0.06579403384138674 -0.13317065501387151 0.2063627112238585 0.0798572534504914 -0.5336540918296736 -0.14708544924812847 0.16182814139109747 0.11937513970742272 0.019728124614240977 0.2461603907344287 -0.1331144725179151 -0.08456059146999423] [-0.14713241949088585 -0.1496100544808649 0.01286409387530723 0.17838636154905402 0.26371468779648805 0.05116414481361818 0.23379095480606613 0.40155086440700305 -0.2880894010985778 -0.43886133965859386 -0.167114615836543 -0.37245814026924007 -0.20179222119266296 -0.2555753621952186 0.1439916651102164 0.02097333804473111 0.23522264350747749 0.059879651174148 0.047547016517435245 0.07267544637893482])
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.5993185958582803
(r/vnoise 0.2 0.3) ;; => 0.5916118107220901
(r/vnoise 0.2 0.3 0.4) ;; => 0.6190284916058346
(r/noise 0.2) ;; => 0.38730107936507935
(r/noise 0.2 0.3) ;; => 0.44062540995047617
(r/noise 0.2 0.3 0.4) ;; => 0.3110611843119072
(r/simplex 0.2) ;; => 0.469390321127619
(r/simplex 0.2 0.3) ;; => 0.1780206523474398
(r/simplex 0.2 0.3 0.4) ;; => 0.5455034338201059
```
:::
...
::: {.printedClojure}
```clojure
{:interpolation :none, :warp-scale 0.0, :seed 665844940, :normalize? true, :noise-type :gradient, :lacunarity 1.90872786462909, :gain 0.24908653479282347, :generator :single, :warp-depth 1, :octaves 6}
...
::: {.printedClojure}
```clojure
{:interpolation :linear, :warp-scale 4.0, :seed 1, :normalize? true, :noise-type :simplex, :lacunarity 1.8874943472437105, :gain 0.508204375355278, :generator :single, :warp-depth 1, :octaves 3}
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.6404198767133961
(some-random-noise 0.2 0.3) ;; => 0.8576043871128607
(some-random-noise 0.2 0.3 0.4) ;; => 0.6490660309890038
```
:::
...
+ `(billow-noise)`
+ `(billow-noise cfg__86870__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__86870__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__86870__auto__)`
