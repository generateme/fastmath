...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x8c540d3 "org.apache.commons.math3.random.JDKRandomGenerator@8c540d3"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => -750694337
(r/drandom (r/rng :mersenne) 0 10) ;; => 9.686503211340117
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.8568800087402604 0.9705080680932283 0.9376684591257638)
(r/->seq (r/rng :mersenne) 3) ;; => (0.2880395893628558 0.6743441316865477 0.5575753442144264)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x6beabebf "org.apache.commons.math3.random.ISAACRandom@6beabebf"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x1ffab996 "org.apache.commons.math3.random.ISAACRandom@1ffab996"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x7a46d866 "org.apache.commons.math3.random.SynchronizedRandomGenerator@7a46d866"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => 356116034
(r/irandom my-prng 5) ;; => 4
(r/irandom my-prng 10 20) ;; => 16
(r/lrandom my-prng) ;; => 3810737284701801971
(r/lrandom my-prng 5) ;; => 1
(r/lrandom my-prng 10 20) ;; => 11
(r/frandom my-prng) ;; => 0.657187
(r/frandom my-prng 2.5) ;; => 2.118285
(r/frandom my-prng 10.1 10.11) ;; => 10.103554
(r/drandom my-prng) ;; => 0.9657700904448023
(r/drandom my-prng 2.5) ;; => 0.3536224776737529
(r/drandom my-prng 10.1 10.11) ;; => 10.105864740462714
(r/grandom my-prng) ;; => 0.6240260782709642
(r/grandom my-prng 20.0) ;; => -14.248724217844106
(r/grandom my-prng 10.0 20.0) ;; => -2.822741494241079
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.5435009503163195 0.5876863197220508)
(r/->seq my-prng 2) ;; => (0.2860307931430264 0.00982513673307328)
(r/->seq my-prng 5 :antithetic) ;; => (0.3742756086353032 0.6257243913646968 0.1626430532306229 0.8373569467693771 0.4653395931358222)
(r/->seq my-prng 5 :uniform) ;; => (0.12938165443971564 0.29764847978791553 0.7338980238154115 0.7545867968930821 0.9005936158788085)
(r/->seq my-prng 5 :systematic) ;; => (0.1776401217434864 0.3776401217434864 0.5776401217434864 0.7776401217434864 0.9776401217434864)
(r/->seq my-prng 5 :stratified) ;; => (0.14997355262896678 0.27311493961588446 0.4513973753548893 0.6842072736716928 0.8450436118007553)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x6e428b61 "org.apache.commons.math3.random.ISAACRandom@6e428b61"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x1af4d673 "org.apache.commons.math3.random.ISAACRandom@1af4d673"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x8c540d3 "org.apache.commons.math3.random.JDKRandomGenerator@8c540d3"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x51fd0a06 "org.apache.commons.math3.random.JDKRandomGenerator@51fd0a06"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x2104b410 "org.apache.commons.math3.random.JDKRandomGenerator@2104b410"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x8c540d3 "org.apache.commons.math3.random.JDKRandomGenerator@8c540d3"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x8c540d3 "org.apache.commons.math3.random.JDKRandomGenerator@8c540d3"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x6eaca465 "org.apache.commons.math3.distribution.CauchyDistribution@6eaca465"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x78ff1f55 "org.apache.commons.math3.distribution.CauchyDistribution@78ff1f55"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 9.789053998165123
(r/frandom log-logistic) ;; => 1.1007425
(r/lrandom log-logistic) ;; => 8
(r/irandom log-logistic) ;; => 9
(r/sample log-logistic) ;; => 3.9566970840802944
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.36982687703528383 0.4023599287539237 0.22781319421079244]
(reduce + (r/sample dirichlet)) ;; => 0.9999999999999999
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 12.399332970434822
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 15.410541659786407
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 2777284.609599426
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.3853584010552223
(r/->seq weibull 3) ;; => (0.3357385318057142 0.6681878625660034 0.7890860455549674)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x1cd1fa25 "org.apache.commons.math3.distribution.CauchyDistribution@1cd1fa25"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (0.6872521205825204 0.4173320978382493 -0.34937501187587766)
...
</code></pre></div></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:f</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">[:rng :numerator-degrees-of-freedom :denominator-degrees-of-freedom :inverse-cumm-accuracy]
...
## ERR
```
Oct 17, 2025 2:16:18 PM clojure.tools.logging$eval39757$fn__39760 invoke
INFO: [:clojisr.v1.session/gc-clean-r-objects {:objects-before 12487, :objects-after 6759}]
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/162.png" /></td><td><img class="clay-image" src="random_files/163.png" /></td><td><img class="clay-image" src="random_files/164.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td>CDF</td><td>iCDF</td></tr><tr><td><img class="clay-image" src="random_files/221.png" /></td><td><img class="clay-image" src="random_files/222.png" /></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.3033356535603671 0.08411255541803263 0.6125517910216003]
(r/sample dirichlet3) ;; => [0.617171179624464 0.09116753889862378 0.2916612814769122]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [15 26 25 40 44]
(r/sample multinomial) ;; => [14 14 28 48 46]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 6.914171762460036
(r/sample mixture-of-three) ;; => 1.8614945634595934
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => 1.4325684020261737
(r/sample truncated-normal) ;; => -0.31155341359348254
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.984542598107459
(r/sample kde-distr) ;; => 0.15978105273963852
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => -0.507749634186901
(r/sample empirical-distr) ;; => 0.1968539665903538
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><dl><dt><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:real-discrete-distribution</code></pre></div></dt><dd><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/499.png" /></td><td><img class="clay-image" src="random_files/500.png" /></td><td><img class="clay-image" src="random_files/501.png" /></td></tr></tbody></table></dd></dl></td></tr><tr><td><dl><dt><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:enumerated-real</code></pre></div></dt><dd><table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/502.png" /></td><td><img class="clay-image" src="random_files/503.png" /></td><td><img class="clay-image" src="random_files/504.png" /></td></tr></tbody></table></dd></dl></td></tr></tbody></table>
```
...
(r/sample cat-distr) ;; => "s"
(r/pdf cat-distr nil) ;; => 0.3100000000000001
(r/pdf cat-distr "ss") ;; => 0.0
(r/cdf cat-distr :b) ;; => 0.8300000000000003
(map (partial r/icdf cat-distr) [1.0E-4 0.5 0.9999]) ;; => (nil "s" :a)
```
:::
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [-0.8518512011906189, 0.08541427297096602, -0.3010723530267088, 0.4200111560969562]
...
::: {.printedClojure}
```clojure
([0.47300721596669326 -0.10890120978408638 0.052737019658180735 -0.027153697745430163 0.16071483507375733 -0.05495073208426855 0.15131358642442264 0.1022708289767613 -0.05063935257941614 0.06883581387193427 0.35673677805932535 -0.34139311206942585 -0.3644940176185578 0.19574245739164386 0.2333898909507769 0.07254759969938807 0.04238995658303227 0.20865411703086717 -0.1765821400566148 -0.3743653621349659] [0.1578076367120805 -0.10151966248495402 -0.17237665969061972 0.19198670931487552 0.199956494627805 -0.11666362831352681 0.13689105811398977 -0.19960720703840643 0.3181152998014141 -0.09134713870372599 0.46825075202840793 -0.2762054899151472 0.20065224374303503 0.16188913291109974 0.4352699865239395 0.2521243533614732 -0.04832520478546405 -0.027704723732561512 -0.22763058766719302 0.08085906274540122])
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td>octaves=2</td><td>octaves=4</td><td>octaves=6</td><td>octaves=8</td></tr><tr><td><img class="clay-image" src="random_files/539.png" /></td><td><img class="clay-image" src="random_files/540.png" /></td><td><img class="clay-image" src="random_files/541.png" /></td><td><img class="clay-image" src="random_files/542.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td></td><td>lacunarity=0.5</td><td>lacunarity=2</td><td>lacunarity=5</td><td>lacunarity=8</td></tr><tr><td>gain=0.25</td><td><img class="clay-image" src="random_files/543.png" /></td><td><img class="clay-image" src="random_files/544.png" /></td><td><img class="clay-image" src="random_files/545.png" /></td><td><img class="clay-image" src="random_files/546.png" /></td></tr><tr><td>gain=0.5</td><td><img class="clay-image" src="random_files/547.png" /></td><td><img class="clay-image" src="random_files/548.png" /></td><td><img class="clay-image" src="random_files/549.png" /></td><td><img class="clay-image" src="random_files/550.png" /></td></tr><tr><td>gain=0.75</td><td><img class="clay-image" src="random_files/551.png" /></td><td><img class="clay-image" src="random_files/552.png" /></td><td><img class="clay-image" src="random_files/553.png" /></td><td><img class="clay-image" src="random_files/554.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td>simplex noise</td><td>value noise</td><td>gradient noise, 1 octave</td></tr><tr><td><img class="clay-image" src="random_files/556.png" /></td><td><img class="clay-image" src="random_files/557.png" /></td><td><img class="clay-image" src="random_files/558.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td>simplex noise</td><td>value noise</td><td>gradient noise, 1 octave</td></tr><tr><td><img class="clay-image" src="random_files/560.png" /></td><td><img class="clay-image" src="random_files/561.png" /></td><td><img class="clay-image" src="random_files/562.png" /></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.46473972426843524
(r/vnoise 0.2 0.3) ;; => 0.6783462098280282
(r/vnoise 0.2 0.3 0.4) ;; => 0.7538737856513611
(r/noise 0.2) ;; => 0.7187885714285713
(r/noise 0.2 0.3) ;; => 0.588198163504762
(r/noise 0.2 0.3 0.4) ;; => 0.6185507771156512
(r/simplex 0.2) ;; => 0.5539103752533333
(r/simplex 0.2 0.3) ;; => 0.5427548421599241
(r/simplex 0.2 0.3 0.4) ;; => 0.32313587284656087
```
:::
...
::: {.printedClojure}
```clojure
{:interpolation :hermite, :warp-scale 0.0, :seed 665844940, :normalize? true, :noise-type :gradient, :lacunarity 1.90872786462909, :gain 0.24908653479282347, :generator :single, :warp-depth 1, :octaves 6}
...
::: {.printedClojure}
```clojure
{:interpolation :none, :warp-scale 4.0, :seed 1, :normalize? true, :noise-type :gradient, :lacunarity 1.8874943472437105, :gain 0.508204375355278, :generator :single, :warp-depth 1, :octaves 3}
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.3089220062346449
(some-random-noise 0.2 0.3) ;; => 0.16013359627971951
(some-random-noise 0.2 0.3 0.4) ;; => 0.07658855016187921
```
:::
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="random_files/573.png" /></td><td><img class="clay-image" src="random_files/574.png" /></td><td><img class="clay-image" src="random_files/575.png" /></td></tr><tr><td><img class="clay-image" src="random_files/576.png" /></td><td><img class="clay-image" src="random_files/577.png" /></td><td><img class="clay-image" src="random_files/578.png" /></td></tr></tbody></table>
```
...
+ `(billow-noise)`
+ `(billow-noise cfg__22287__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__22287__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__22287__auto__)`
