...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x486ddd4 "org.apache.commons.math3.random.JDKRandomGenerator@486ddd4"]
...
::: {.sourceClojure}
```clojure
(r/irandom (r/rng :mersenne)) ;; => 583171829
(r/drandom (r/rng :mersenne) 0 10) ;; => 0.16062515224301022
```
:::
...
::: {.sourceClojure}
```clojure
(take 3 (r/->seq (r/rng :mersenne))) ;; => (0.7916490450961611 0.6714084898271204 0.41183088626438136)
(r/->seq (r/rng :mersenne) 3) ;; => (0.0029262972594876757 0.2258647455715712 0.7498125199480845)
```
:::
...
::: {.sourceClojure}
```clojure
(r/rng :isaac) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x76123b73 "org.apache.commons.math3.random.ISAACRandom@76123b73"]
(r/rng :isaac 5336) ;; => #object[org.apache.commons.math3.random.ISAACRandom 0x76bc22eb "org.apache.commons.math3.random.ISAACRandom@76bc22eb"]
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x58a27150 "org.apache.commons.math3.random.SynchronizedRandomGenerator@58a27150"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/irandom my-prng) ;; => -427948238
(r/irandom my-prng 5) ;; => 0
(r/irandom my-prng 10 20) ;; => 17
(r/lrandom my-prng) ;; => 7069220120318214370
(r/lrandom my-prng 5) ;; => 4
(r/lrandom my-prng 10 20) ;; => 16
(r/frandom my-prng) ;; => 0.76075315
(r/frandom my-prng 2.5) ;; => 0.14151245
(r/frandom my-prng 10.1 10.11) ;; => 10.106586
(r/drandom my-prng) ;; => 0.4737487008454486
(r/drandom my-prng 2.5) ;; => 2.130061369720813
(r/drandom my-prng 10.1 10.11) ;; => 10.107980443631616
(r/grandom my-prng) ;; => -0.9085796314817088
(r/grandom my-prng 20.0) ;; => -14.345711108856428
(r/grandom my-prng 10.0 20.0) ;; => 29.150858880816138
...
::: {.sourceClojure}
```clojure
(take 2 (r/->seq my-prng)) ;; => (0.6404590241385248 0.145855142970156)
(r/->seq my-prng 2) ;; => (0.7456905995687391 0.04879225146067179)
(r/->seq my-prng 5 :antithetic) ;; => (0.11312280468970615 0.8868771953102939 0.3929763011924128 0.6070236988075872 0.7276423683956685)
(r/->seq my-prng 5 :uniform) ;; => (0.2380250850055827 0.6770051409527753 0.7426601821133564 0.7442617361463256 0.7966132339816959)
(r/->seq my-prng 5 :systematic) ;; => (0.18429704790892423 0.38429704790892427 0.5842970479089242 0.7842970479089243 0.9842970479089242)
(r/->seq my-prng 5 :stratified) ;; => (0.0066064205362761814 0.21441891865387175 0.4568213601356318 0.7907990391217048 0.9338984012182693)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x243d6192 "org.apache.commons.math3.random.ISAACRandom@243d6192"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x4fc80a6c "org.apache.commons.math3.random.ISAACRandom@4fc80a6c"]
...
r/default-rng ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x486ddd4 "org.apache.commons.math3.random.JDKRandomGenerator@486ddd4"]
(r/set-seed) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0xce50bd6 "org.apache.commons.math3.random.JDKRandomGenerator@ce50bd6"]
(r/set-seed 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x431f38ba "org.apache.commons.math3.random.JDKRandomGenerator@431f38ba"]
(r/set-seed!) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x486ddd4 "org.apache.commons.math3.random.JDKRandomGenerator@486ddd4"]
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x486ddd4 "org.apache.commons.math3.random.JDKRandomGenerator@486ddd4"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/distribution :cauchy) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x41daea7d "org.apache.commons.math3.distribution.CauchyDistribution@41daea7d"]
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x41fb1039 "org.apache.commons.math3.distribution.CauchyDistribution@41fb1039"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 7.947286855101702
(r/frandom log-logistic) ;; => 15.861931
(r/lrandom log-logistic) ;; => 4
(r/irandom log-logistic) ;; => 10
(r/sample log-logistic) ;; => 3.4760010210460544
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.057054345778283666 0.2958940007343679 0.6470516534873483]
...
(r/log-likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 10.870705561468526
(r/observe dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 10.553670519438617
(r/likelihood dirichlet (repeatedly 10 (fn* [] (r/sample dirichlet)))) ;; => 50835.11268895504
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 0.2712825707579468
(r/->seq weibull 3) ;; => (0.2737727081165921 0.6254847771527833 1.2988730172136629)
...
(r/set-seed! cauchy-mersenne-2288 2288) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x73519a4e "org.apache.commons.math3.distribution.CauchyDistribution@73519a4e"]
(vec (r/->seq cauchy-mersenne-2288 3)) ;; => [-0.1079136480774541 -5.558982159984645 -3.127061922456471]
```
:::
...
::: {.sourceClojure}
```clojure
(r/->seq r/default-normal 3) ;; => (-1.026145780244907 -0.6178009358581672 0.3164321142416798)
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.3484193435611704 0.012074119935907124 0.6395065365029224]
(r/sample dirichlet3) ;; => [0.2663453029031555 0.23546338138749023 0.49819131570935415]
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [5 18 25 44 58]
(r/sample multinomial) ;; => [8 18 31 39 54]
...
::: {.sourceClojure}
```clojure
(r/sample mixture-of-three) ;; => 10.585506004922227
(r/sample mixture-of-three) ;; => 1.2914754892897997
...
::: {.sourceClojure}
```clojure
(r/sample truncated-normal) ;; => -0.6081481527523805
(r/sample truncated-normal) ;; => -0.1772636584539129
...
::: {.sourceClojure}
```clojure
(r/sample kde-distr) ;; => 0.22430711731589728
(r/sample kde-distr) ;; => -0.7640372605094901
...
::: {.sourceClojure}
```clojure
(r/sample empirical-distr) ;; => 2.757207588002772
(r/sample empirical-distr) ;; => -0.5120424926472082
...
(r/pdf cat-distr nil) ;; => 0.3000000000000001
(r/pdf cat-distr "ss") ;; => 0.0
(r/cdf cat-distr :b) ;; => 0.4800000000000001
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :sphere 4)) ;; => #vec4 [0.761580951372076, -0.4261689067153752, 0.1345060522617425, 0.46934277384571166]
(first (r/sequence-generator :ball 3)) ;; => #vec3 [-0.09484403712094484, 0.256532186706959, 0.5296654723540002]
```
:::
...
([-0.07277181285641145
  ...
  0.20383315972960805
  -0.09229757495443637
  0.053662753689202765
  -0.08955391945677081
  0.06388804088708416
  0.273104617555616
  -0.034290761866920635
  0.17704713196153127
  -0.04279382128110439
  0.12134010189437565
  -0.2992151191586851
...
::: {.sourceClojure}
```clojure
(first (r/sequence-generator :default 4)) ;; => #vec4 [0.7127404164008856, 0.8708610707667607, 0.8204722467893281, 0.8912560491467851]
(first (r/sequence-generator :gaussian 3)) ;; => #vec3 [-0.02180620578197646, -1.3973138344882077, -1.5207178077844978]
```
:::
...
::: {.sourceClojure}
```clojure
(r/vnoise 0.2) ;; => 0.2822585996184157
(r/vnoise 0.2 0.3) ;; => 0.7642254924043814
(r/vnoise 0.2 0.3 0.4) ;; => 0.7605721661412654
(r/noise 0.2) ;; => 0.6166973968253968
(r/noise 0.2 0.3) ;; => 0.4379502122260318
(r/noise 0.2 0.3 0.4) ;; => 0.45376094113030013
(r/simplex 0.2) ;; => 0.4272056380952381
(r/simplex 0.2 0.3) ;; => 0.7830415389487952
(r/simplex 0.2 0.3 0.4) ;; => 0.47063891453968254
```
:::
...
{:interpolation :quintic,
 ...
 :normalize? true,
 :noise-type :simplex,
 :lacunarity 2.0619624147982485,
 :gain 0.6959424362491087,
 :generator :single,
 :warp-depth 3,
 :octaves 5}
...
{:interpolation :linear,
 ...
 :normalize? true,
 :noise-type :simplex,
 :lacunarity 2.161255284804618,
 :gain 0.44178683489868176,
 :generator :single,
 :warp-depth 1,
 :octaves 1}
...
::: {.sourceClojure}
```clojure
(some-random-noise 0.2) ;; => 0.3268150842883826
(some-random-noise 0.2 0.3) ;; => 0.2011593413112634
(some-random-noise 0.2 0.3 0.4) ;; => 0.2664466102957099
```
:::
...
+ `(billow-noise)`
+ `(billow-noise cfg__65187__auto__)`
...
+ `(ridgedmulti-noise)`
+ `(ridgedmulti-noise cfg__65187__auto__)`
...
+ `(single-noise)`
+ `(single-noise cfg__65187__auto__)`
