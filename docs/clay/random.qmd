...
<script src="random_files/md-default247.js" type="text/javascript"></script><script src="random_files/md-default248.js" type="text/javascript"></script>
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.JDKRandomGenerator 0x66ec8ec2 "org.apache.commons.math3.random.JDKRandomGenerator@66ec8ec2"]
...
(r/synced-rng (r/rng :isaac)) ;; => #object[org.apache.commons.math3.random.SynchronizedRandomGenerator 0x71cf2d46 "org.apache.commons.math3.random.SynchronizedRandomGenerator@71cf2d46"]
```
:::
...
(r/->seq my-prng 5 :stratified) ;; => (0.15036576820310113 0.39288747613351066 0.4024569446899115 0.6813400263610344 0.9067794745388689)
```
:::
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x7e7ba061 "org.apache.commons.math3.random.ISAACRandom@7e7ba061"]
...
::: {.printedClojure}
```clojure
#object[org.apache.commons.math3.random.ISAACRandom 0x11e3dbfe "org.apache.commons.math3.random.ISAACRandom@11e3dbfe"]
...
(r/set-seed! 9988) ;; => #object[org.apache.commons.math3.random.JDKRandomGenerator 0x66ec8ec2 "org.apache.commons.math3.random.JDKRandomGenerator@66ec8ec2"]
```
:::
...
(r/distribution :cauchy {:median 2.0, :scale 2.0}) ;; => #object[org.apache.commons.math3.distribution.CauchyDistribution 0x412f3f72 "org.apache.commons.math3.distribution.CauchyDistribution@412f3f72"]
```
:::
...
::: {.sourceClojure}
```clojure
(r/drandom log-logistic) ;; => 9.38119207031292
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet) ;; => [0.5266513175880663 0.20201103895118547 0.2713376434607484]
...
::: {.sourceClojure}
```clojure
(r/sample weibull) ;; => 1.660596406669419
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/0.png" /></td><td><img class="clay-image" src="random_files/1.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/2.png" /></td><td><img class="clay-image" src="random_files/3.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 3, :beta 3}
</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha 5, :beta 2}
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/4.png" /></td><td><img class="clay-image" src="random_files/5.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/6.png" /></td><td><img class="clay-image" src="random_files/7.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/8.png" /></td><td><img class="clay-image" src="random_files/9.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/10.png" /></td><td><img class="clay-image" src="random_files/11.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/12.png" /></td><td><img class="clay-image" src="random_files/13.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/14.png" /></td><td><img class="clay-image" src="random_files/15.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/16.png" /></td><td><img class="clay-image" src="random_files/17.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/18.png" /></td><td><img class="clay-image" src="random_files/19.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/20.png" /></td><td><img class="clay-image" src="random_files/21.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/22.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:numerator-degrees-of-freedom 10, :denominator-degrees-of-freedom 15}
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/23.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/24.png" /></td><td><img class="clay-image" src="random_files/25.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/26.png" /></td><td><img class="clay-image" src="random_files/27.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/28.png" /></td><td><img class="clay-image" src="random_files/29.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/30.png" /></td><td><img class="clay-image" src="random_files/31.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/32.png" /></td><td><img class="clay-image" src="random_files/33.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/34.png" /></td><td><img class="clay-image" src="random_files/35.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/36.png" /></td><td><img class="clay-image" src="random_files/37.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/38.png" /></td><td><img class="clay-image" src="random_files/39.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/40.png" /></td><td><img class="clay-image" src="random_files/41.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/42.png" /></td><td><img class="clay-image" src="random_files/43.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/44.png" /></td><td><img class="clay-image" src="random_files/45.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/46.png" /></td><td><img class="clay-image" src="random_files/47.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/48.png" /></td><td><img class="clay-image" src="random_files/49.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/50.png" /></td><td><img class="clay-image" src="random_files/51.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/52.png" /></td><td><img class="clay-image" src="random_files/53.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/55.png" /></td><td><img class="clay-image" src="random_files/56.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/57.png" /></td><td><img class="clay-image" src="random_files/58.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/59.png" /></td><td><img class="clay-image" src="random_files/60.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/61.png" /></td><td><img class="clay-image" src="random_files/62.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/63.png" /></td><td><img class="clay-image" src="random_files/64.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/65.png" /></td><td><img class="clay-image" src="random_files/66.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/67.png" /></td><td><img class="clay-image" src="random_files/68.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/69.png" /></td><td><img class="clay-image" src="random_files/70.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/71.png" /></td><td><img class="clay-image" src="random_files/72.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/73.png" /></td><td><img class="clay-image" src="random_files/74.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>CDF</td><td>iCDF</td></tr><tr><td><img class="clay-image" src="random_files/75.png" /></td><td><img class="clay-image" src="random_files/76.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/77.png" /></td><td><img class="clay-image" src="random_files/78.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/79.png" /></td><td><img class="clay-image" src="random_files/80.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/81.png" /></td><td><img class="clay-image" src="random_files/82.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/83.png" /></td><td><img class="clay-image" src="random_files/84.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/85.png" /></td><td><img class="clay-image" src="random_files/86.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/87.png" /></td><td><img class="clay-image" src="random_files/88.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/89.png" /></td><td><img class="clay-image" src="random_files/90.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/91.png" /></td><td><img class="clay-image" src="random_files/92.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/93.png" /></td><td><img class="clay-image" src="random_files/94.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/95.png" /></td><td><img class="clay-image" src="random_files/96.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/97.png" /></td><td><img class="clay-image" src="random_files/98.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/99.png" /></td><td><img class="clay-image" src="random_files/100.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/101.png" /></td><td><img class="clay-image" src="random_files/102.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/103.png" /></td><td><img class="clay-image" src="random_files/104.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/105.png" /></td><td><img class="clay-image" src="random_files/106.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/107.png" /></td><td><img class="clay-image" src="random_files/108.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/109.png" /></td><td><img class="clay-image" src="random_files/110.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/111.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:population-size 2000, :number-of-successes 20, :sample-size 200}
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/112.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/113.png" /></td><td><img class="clay-image" src="random_files/114.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/115.png" /></td><td><img class="clay-image" src="random_files/116.png" /></td><td><img class="clay-image" src="random_files/117.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/118.png" /></td><td><img class="clay-image" src="random_files/119.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/120.png" /></td><td><img class="clay-image" src="random_files/121.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/122.png" /></td><td><img class="clay-image" src="random_files/123.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/124.png" /></td><td><img class="clay-image" src="random_files/125.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/126.png" /></td><td><img class="clay-image" src="random_files/127.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/128.png" /></td><td><img class="clay-image" src="random_files/129.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/130.png" /></td><td><img class="clay-image" src="random_files/131.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/132.png" /></td><td><img class="clay-image" src="random_files/133.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/134.png" /></td><td><img class="clay-image" src="random_files/135.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/136.png" /></td><td><img class="clay-image" src="random_files/137.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/138.png" /></td><td><img class="clay-image" src="random_files/139.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/140.png" /></td><td><img class="clay-image" src="random_files/141.png" /></td></tr></tbody></table>
```
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/142.png" /></td><td><img class="clay-image" src="random_files/143.png" /></td><td><img class="clay-image" src="random_files/144.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:alpha [3 1 3]}
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/145.png" /></td><td><img class="clay-image" src="random_files/146.png" /></td><td><img class="clay-image" src="random_files/147.png" /></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample dirichlet3) ;; => [0.35468848696827415 0.04162425855397151 0.6036872544777543]
...
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/148.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:means [0.5 0], :convariances [[0.5 -0.1] [0.1 0.1]]}
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/149.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure printed-clojure">{:means [0 -0.5], :convariances [[1 0.2] [0.3 1]]}
</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/150.png" /></td></tr></tbody></table>
```
...
::: {.sourceClojure}
```clojure
(r/sample multinomial) ;; => [15 18 28 31 58]
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>three normals</td><td>gamma, laplace and log-logistic</td></tr><tr><td><img class="clay-image" src="random_files/151.png" /></td><td><img class="clay-image" src="random_files/152.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>truncated normal</td><td>trucated levy (left side)</td></tr><tr><td><img class="clay-image" src="random_files/153.png" /></td><td><img class="clay-image" src="random_files/154.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>default</td><td>bandwidth=1.0</td></tr><tr><td><img class="clay-image" src="random_files/155.png" /></td><td><img class="clay-image" src="random_files/156.png" /></td></tr><tr><td>gaussian kernel</td><td>triangular kernel, bandwidth=0.1</td></tr><tr><td><img class="clay-image" src="random_files/157.png" /></td><td><img class="clay-image" src="random_files/158.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:cauchy</code></pre></div></td><td><img class="clay-image" src="random_files/159.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:cosine</code></pre></div></td><td><img class="clay-image" src="random_files/160.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:epanechnikov</code></pre></div></td><td><img class="clay-image" src="random_files/161.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:gaussian</code></pre></div></td><td><img class="clay-image" src="random_files/162.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:laplace</code></pre></div></td><td><img class="clay-image" src="random_files/163.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:logistic</code></pre></div></td><td><img class="clay-image" src="random_files/164.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:quartic</code></pre></div></td><td><img class="clay-image" src="random_files/165.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:sigmoid</code></pre></div></td><td><img class="clay-image" src="random_files/166.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:silverman</code></pre></div></td><td><img class="clay-image" src="random_files/167.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:triangular</code></pre></div></td><td><img class="clay-image" src="random_files/168.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:tricube</code></pre></div></td><td><img class="clay-image" src="random_files/169.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:triweight</code></pre></div></td><td><img class="clay-image" src="random_files/170.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:uniform</code></pre></div></td><td><img class="clay-image" src="random_files/171.png" /></td></tr><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:wigner</code></pre></div></td><td><img class="clay-image" src="random_files/172.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>default</td><td>bin-count=10</td></tr><tr><td><img class="clay-image" src="random_files/173.png" /></td><td><img class="clay-image" src="random_files/174.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:real-discrete-distribution</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:enumerated-real</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/175.png" /></td><td><img class="clay-image" src="random_files/176.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:integer-discrete-distribution</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:enumerated-int</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/177.png" /></td><td><img class="clay-image" src="random_files/178.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>:sobol</td><td>:halton</td><td>:r2</td></tr><tr><td><img class="clay-image" src="random_files/179.png" /></td><td><img class="clay-image" src="random_files/180.png" /></td><td><img class="clay-image" src="random_files/181.png" /></td></tr><tr><td>:sobol (jittered)</td><td>:halton (jittered)</td><td>:r2 (jittered)</td></tr><tr><td><img class="clay-image" src="random_files/182.png" /></td><td><img class="clay-image" src="random_files/183.png" /></td><td><img class="clay-image" src="random_files/184.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:sphere</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:ball</code></pre></div></td></tr><tr><td><img class="clay-image" src="random_files/185.png" /></td><td><img class="clay-image" src="random_files/186.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>:default</td><td>:gaussian</td></tr><tr><td><img class="clay-image" src="random_files/187.png" /></td><td><img class="clay-image" src="random_files/188.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:none</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:linear</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:hermite</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:quintic</code></pre></div></td></tr><tr><td>value</td><td><img class="clay-image" src="random_files/190.png" /></td><td><img class="clay-image" src="random_files/191.png" /></td><td><img class="clay-image" src="random_files/192.png" /></td><td><img class="clay-image" src="random_files/193.png" /></td></tr><tr><td>gradient</td><td><img class="clay-image" src="random_files/194.png" /></td><td><img class="clay-image" src="random_files/195.png" /></td><td><img class="clay-image" src="random_files/196.png" /></td><td><img class="clay-image" src="random_files/197.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light"></code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:none</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:linear</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:hermite</code></pre></div></td><td><div><pre><code class="sourceCode language-clojure source-clojure bg-light">:quintic</code></pre></div></td></tr><tr><td>value</td><td><img class="clay-image" src="random_files/199.png" /></td><td><img class="clay-image" src="random_files/200.png" /></td><td><img class="clay-image" src="random_files/201.png" /></td><td><img class="clay-image" src="random_files/202.png" /></td></tr><tr><td>gradient</td><td><img class="clay-image" src="random_files/203.png" /></td><td><img class="clay-image" src="random_files/204.png" /></td><td><img class="clay-image" src="random_files/205.png" /></td><td><img class="clay-image" src="random_files/206.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>octaves=2</td><td>octaves=4</td><td>octaves=6</td><td>octaves=8</td></tr><tr><td><img class="clay-image" src="random_files/207.png" /></td><td><img class="clay-image" src="random_files/208.png" /></td><td><img class="clay-image" src="random_files/209.png" /></td><td><img class="clay-image" src="random_files/210.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td></td><td>lacunarity=0.5</td><td>lacunarity=2</td><td>lacunarity=5</td><td>lacunarity=8</td></tr><tr><td>gain=0.25</td><td><img class="clay-image" src="random_files/211.png" /></td><td><img class="clay-image" src="random_files/212.png" /></td><td><img class="clay-image" src="random_files/213.png" /></td><td><img class="clay-image" src="random_files/214.png" /></td></tr><tr><td>gain=0.5</td><td><img class="clay-image" src="random_files/215.png" /></td><td><img class="clay-image" src="random_files/216.png" /></td><td><img class="clay-image" src="random_files/217.png" /></td><td><img class="clay-image" src="random_files/218.png" /></td></tr><tr><td>gain=0.75</td><td><img class="clay-image" src="random_files/219.png" /></td><td><img class="clay-image" src="random_files/220.png" /></td><td><img class="clay-image" src="random_files/221.png" /></td><td><img class="clay-image" src="random_files/222.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>simplex noise</td><td>value noise</td><td>gradient noise, 1 octave</td></tr><tr><td><img class="clay-image" src="random_files/224.png" /></td><td><img class="clay-image" src="random_files/225.png" /></td><td><img class="clay-image" src="random_files/226.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>simplex noise</td><td>value noise</td><td>gradient noise, 1 octave</td></tr><tr><td><img class="clay-image" src="random_files/228.png" /></td><td><img class="clay-image" src="random_files/229.png" /></td><td><img class="clay-image" src="random_files/230.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td>vnoise</td><td>noise</td><td>simplex</td></tr><tr><td><img class="clay-image" src="random_files/231.png" /></td><td><img class="clay-image" src="random_files/232.png" /></td><td><img class="clay-image" src="random_files/233.png" /></td></tr></tbody></table>
```
...
(r/simplex 0.2 0.3 0.4) ;; => 0.3985014003809524
```
:::
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td></td><td>vnoise</td><td>noise</td><td>simplex</td></tr><tr><td>scale=2</td><td><img class="clay-image" src="random_files/234.png" /></td><td><img class="clay-image" src="random_files/235.png" /></td><td><img class="clay-image" src="random_files/236.png" /></td></tr><tr><td>scale=4</td><td><img class="clay-image" src="random_files/237.png" /></td><td><img class="clay-image" src="random_files/238.png" /></td><td><img class="clay-image" src="random_files/239.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive"><tbody><tr><td><img class="clay-image" src="random_files/241.png" /></td><td><img class="clay-image" src="random_files/242.png" /></td><td><img class="clay-image" src="random_files/243.png" /></td></tr><tr><td><img class="clay-image" src="random_files/244.png" /></td><td><img class="clay-image" src="random_files/245.png" /></td><td><img class="clay-image" src="random_files/246.png" /></td></tr></tbody></table>
```
