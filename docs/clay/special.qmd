...
<script src="special_files/md-default77.js" type="text/javascript"></script><script src="special_files/md-default78.js" type="text/javascript"></script>
...
```{=html}
<img class="clay-image" src="special_files/7.png" />
```
...
```{=html}
<img class="clay-image" src="special_files/8.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/11.png" /></td><td><img class="clay-image" src="special_files/12.png" /></td></tr></tbody></table>
```
...
```{=html}
<img class="clay-image" src="special_files/17.png" />
```
...
```{=html}
<img class="clay-image" src="special_files/18.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/21.png" /></td><td><img class="clay-image" src="special_files/22.png" /></td></tr></tbody></table>
```
...
```{=html}
<img class="clay-image" src="special_files/23.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/28.png" /></td><td><img class="clay-image" src="special_files/29.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/30.png" /></td><td><img class="clay-image" src="special_files/31.png" /></td></tr><tr><td><img class="clay-image" src="special_files/32.png" /></td><td><img class="clay-image" src="special_files/33.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/34.png" /></td><td><img class="clay-image" src="special_files/35.png" /></td></tr></tbody></table>
```
...
```{=html}
<img class="clay-image" src="special_files/36.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/45.png" /></td><td><img class="clay-image" src="special_files/46.png" /></td></tr></tbody></table>
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/47.png" /></td><td><img class="clay-image" src="special_files/48.png" /></td></tr><tr><td><img class="clay-image" src="special_files/49.png" /></td><td><img class="clay-image" src="special_files/50.png" /></td></tr></tbody></table>
```
...
```{=html}
<img class="clay-image" src="special_files/51.png" />
```
...
```{=html}
<img class="clay-image" src="special_files/52.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/53.png" /></td><td><img class="clay-image" src="special_files/54.png" /></td></tr></tbody></table>
```
...
```{=html}
<img class="clay-image" src="special_files/64.png" />
```
...
## ERR
```
Feb 16, 2026 10:13:11 PM clojure.tools.logging$eval56375$fn__56378 invoke
INFO: [:clojisr.v1.session/gc-clean-r-objects {:objects-before 17073, :objects-after 5450}]
...
```{=html}
<img class="clay-image" src="special_files/65.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/67.png" /></td><td><img class="clay-image" src="special_files/68.png" /></td></tr></tbody></table>
```
...
```{=html}
<img class="clay-image" src="special_files/69.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/71.png" /></td><td><img class="clay-image" src="special_files/72.png" /></td></tr></tbody></table>
```
...
```{=html}
<img class="clay-image" src="special_files/73.png" />
```
...
```{=html}
<img class="clay-image" src="special_files/74.png" />
```
...
```{=html}
<table class="table table-hover table-responsive clay-table"><tbody><tr><td><img class="clay-image" src="special_files/75.png" /></td><td><img class="clay-image" src="special_files/76.png" /></td></tr></tbody></table>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1458">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1532">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1575">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1580">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1826">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1607">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1792">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1384">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1907">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1916">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1925">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1193">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1072">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1098">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L576">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L366">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L396">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1041">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L793">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L811">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L849">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L771">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L597">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L649">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L136">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L90">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L273">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L36">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L46">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L258">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L66">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2282">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1351">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2030">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2039">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2058">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2034">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2053">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2065">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2089">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2096">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2192">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L152">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L52">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L58">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L84">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L430">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1995">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1965">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1981">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1859">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L130">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L72">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L78">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2223">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1878">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1369">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2142">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L346">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L143">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1889">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1447">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1270">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1276">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1282">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1313">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1299">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1303">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1307">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1231">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1210">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1216">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1223">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1335">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1322">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1326">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1330">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1261">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1240">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1246">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1253">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1356">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1361">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2070">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2286">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L110">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L1871">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2023">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L2082">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L279">source</a></small><hr style="margin: 0" /></div>
```
...
```{=html}
<div style="text-align: right"><small><a href="https://github.com/generateme/fastmath/tree/3.x/src/fastmath/special.clj#L217">source</a></small><hr style="margin: 0" /></div>
```
