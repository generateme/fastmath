...
{:accuracy 0.9278350515463918,
 ...
 :f-beta #<Fn@3fe7d87a fastmath.stats/binary_measures_all_calc[fn]>,
...
{:alpha 0.05,
 ...
 :ci-sides :two-sided,
 :confidence-interval ([0.06666666666666667 0.26666666666666666]
                       [0.11666666666666667 0.31666666666666665]
                       [0.05 0.21666666666666667]
                       [0.1 0.2833333333333333]
                       [0.06666666666666667 0.2495833333333337]
                       [0.06708333333333337 0.26666666666666666]),
 :df 5,
...
{:alpha 0.05,
 ...
 :ci-sides :two-sided,
 :confidence-interval ([0.0625 0.3429687500000007]
                       [0.21875 0.53125]
...
{:alpha 0.05,
 ...
 :ci-sides :two-sided,
 :confidence-interval
   {[0 0] [0.33 0.52], [0 1] [0.04 0.15], [1 0] [0.34 0.54], [1 1] [0.01 0.08]},
 :df 1,
...
{:alpha 0.05,
 ...
 :confidence-interval {[0 0] [0.17 0.28500000000000003],
                       [0 1] [0.135 0.25],
                       [0 2] [0.09 0.185],
                       [1 0] [0.08 0.17987500000000012],
                       [1 1] [0.2 0.32487500000000014],
                       [1 2] [0.03 0.095]},
 :df 2,
 :estimate
...
::: {.sourceClojure}
```clojure
{:d 0.1922686714932923,
 :dn 0.1922686714932923,
 :dp 0.14910575415649788,
 :n 15,
 :p-value 0.5713038606247604,
 :sides :two-sided,
 :stat 0.1922686714932923}
```
:::
...
::: {.sourceClojure}
```clojure
(stats/acf ma10 10) ;; => (1.0 0.34333128489974724 -0.04020951403279583 0.04612241594908516 0.1852261875945985 -0.22794561155954585 -0.35738099746291124 0.013651328645174501 0.03600969057219244 -0.09007799495415146 -0.2157692795489925)
(stats/pacf ma10 10) ;; => (0.0 0.34333128489974724 -0.1792105778156415 0.1451525580297481 0.12676287506243786 -0.4069232305134586 -0.10004861107482318 0.20392390032603722 -0.18294108608004425 0.11992350679976624 -0.24155194306424108)
(stats/acf-ci ma10 10) ;; => {:ci 0.06197950323045615, :acf (1.0 0.34333128489974724 -0.04020951403279583 0.04612241594908516 0.1852261875945985 -0.22794561155954585 -0.35738099746291124 0.013651328645174501 0.03600969057219244 -0.09007799495415146 -0.2157692795489925), :cis (0.06197950323045615 0.06889915291510926 0.06898923866967133 0.06910758820965988 0.07098908350120713 0.07374719143606621 0.08012440034927212 0.08013333457707303 0.08019547202280405 0.08058320714502538 0.08277283444671166)}
(stats/pacf-ci ma10 10) ;; => {:ci 0.06197950323045615, :pacf (0.0 0.34333128489974724 -0.1792105778156415 0.1451525580297481 0.12676287506243786 -0.4069232305134586 -0.10004861107482318 0.20392390032603722 -0.18294108608004425 0.11992350679976624 -0.24155194306424108)}
```
:::
...
::: {.sourceClojure}
```clojure
(stats/acf arfima 10) ;; => (1.0 0.6506370142553352 0.16428399406393412 -0.05371935954843326 -0.08238133657224342 -0.03858218557773726 -0.00951535411400732 -0.010216213594883172 -0.021065858669019076 0.006811592076362181 0.05775440126659869)
(stats/pacf arfima 10) ;; => (0.0 0.6506370142553352 -0.4492064219914764 0.18171867955331056 -0.09802208765290751 0.06376486326864708 -0.05386210411379767 0.011804359331060452 -0.024226137616979636 0.07619008764910891 0.014687478951990327)
(stats/acf-ci arfima 10) ;; => {:ci 0.06197950323045615, :acf (1.0 0.6506370142553352 0.16428399406393412 -0.05371935954843326 -0.08238133657224342 -0.03858218557773726 -0.00951535411400732 -0.010216213594883172 -0.021065858669019076 0.006811592076362181 0.05775440126659869), :cis (0.06197950323045615 0.08422503789425191 0.08544713596723832 0.08557677357261118 0.08588088095761699 0.08594743969631259 0.08595148641415772 0.08595615097685334 0.08597598119359694 0.08597805424976211 0.08612695703914625)}
(stats/pacf-ci arfima 10) ;; => {:ci 0.06197950323045615, :pacf (0.0 0.6506370142553352 -0.4492064219914764 0.18171867955331056 -0.09802208765290751 0.06376486326864708 -0.05386210411379767 0.011804359331060452 -0.024226137616979636 0.07619008764910891 0.014687478951990327)}
```
:::
...
::: {.printedClojure}
```clojure
{:data (21 21 22.8 21.4 18.7 18.1 14.3 24.4 22.8 19.2 17.8 16.4 17.3 15.2 10.4 10.4 14.7 32.4 30.4 33.9 21.5 15.5 15.2 13.3 19.2 27.3 26 30.4 15.8 19.7 15 21.4), :model #object[fastmath.random$eval88021$fn$reify__88035 0x55997fc4 "fastmath.random$eval88021$fn$reify__88035@55997fc4"], :samples ((30.4 21.4 18.1 21.4 26.0 19.2 22.8 33.9 30.4 15.0 22.8 33.9 16.4 30.4 21.4 21.0 21.5 21.4 14.7 19.2 21.0 18.1 15.2 18.1 16.4 26.0 14.7 18.1 21.4 26.0 21.4 19.7) (17.3 10.4 10.4 15.8 15.2 32.4 21.0 18.7 21.0 22.8 10.4 22.8 22.8 15.8 13.3 18.1 22.8 21.4 26.0 24.4 15.2 22.8 16.4 17.8 22.8 33.9 14.7 21.5 27.3 15.8 27.3 15.5))}
...
::: {.printedClojure}
```clojure
{:data (21 21 22.8 21.4 18.7 18.1 14.3 24.4 22.8 19.2 17.8 16.4 17.3 15.2 10.4 10.4 14.7 32.4 30.4 33.9 21.5 15.5 15.2 13.3 19.2 27.3 26 30.4 15.8 19.7 15 21.4), :model #object[fastmath.random$eval88021$fn$reify__88035 0x584e4921 "fastmath.random$eval88021$fn$reify__88035@584e4921"], :samples ((32.4 30.4 21.0 21.5 30.4 21.5 18.7 21.0 21.5 30.4 17.8 14.7 14.3 30.4 15.8 27.3 30.4 15.0 18.7 24.4 15.2 19.2 19.2 14.7 21.4 22.8 21.0 21.0 17.8 24.4 21.5 15.8) (10.4 13.3 18.1 15.8 14.3 15.8 19.7 17.8 15.8 13.3 21.0 27.3 30.4 13.3 21.5 14.7 13.3 26.0 19.7 15.2 24.4 19.2 19.2 27.3 16.4 15.5 18.1 17.8 21.0 15.2 15.8 21.5))}
...
{:data [:cat :dog :cat :dog :dog],
 :model
   #object[fastmath.random$eval88046$fn$reify__88050 0x5cda537d "fastmath.random$eval88046$fn$reify__88050@5cda537d"],
 :samples ((:dog :cat
                 :cat :dog
                 :dog :cat
                 :cat :cat
...
{:bias 0.0156343750000012,
 :data (21
        ...
        21.4),
 :mean 20.106259375,
 :median 20.042187499999997,
 :model
   #object[fastmath.random$eval88021$fn$reify__88035 0x7370080f "fastmath.random$eval88021$fn$reify__88035@7370080f"],
 :sem 0.18769814611674918,
 :statistic #<Fn@59a74d7c fastmath.stats/mean>,
 :stddev 1.0617810554823743,
 :t0 20.090625,
 :variance 1.1273790097812648}
```
:::
